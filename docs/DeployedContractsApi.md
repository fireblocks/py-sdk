...
with fireblocks_client.ApiClient(configuration) as api_client:
    ...
    api_instance = fireblocks_client.DeployedContractsApi(api_client)
    contract_address = '0xC2c4e1Db41F0bB97996D0eD0542D2170d146FB66' # str | The contract's onchain address
    asset_id = 'asset_id_example' # str | 

    try:
        # Return deployed contract data
        api_response = api_instance.get_deployed_contract_by_address(contract_address, asset_id)
...
with fireblocks_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Return deployed contract data by id
        api_response = api_instance.get_deployed_contract_by_id(id)
...
with fireblocks_client.ApiClient(configuration) as api_client:
    ...
    try:
        # List deployed contracts data
        api_response = api_instance.get_deployed_contracts(page_cursor=page_cursor, page_size=page_size, contract_address=contract_address, asset_id=asset_id, template_id=template_id)
