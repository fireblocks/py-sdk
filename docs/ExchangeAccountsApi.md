...
with fireblocks_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Convert exchange account funds from the source asset to the destination asset.
        api_response = api_instance.convert_assets(exchange_account_id, idempotency_key=idempotency_key, convert_assets_request=convert_assets_request)
...
with fireblocks_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Find a specific exchange account
        api_response = api_instance.get_exchange_account(exchange_account_id)
...
with fireblocks_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Pagination list exchange accounts
        api_response = api_instance.get_paged_exchange_accounts(limit, before=before, after=after)
...
with fireblocks_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Internal transfer for exchange accounts
        api_response = api_instance.internal_transfer(exchange_account_id, idempotency_key=idempotency_key, create_internal_transfer_request=create_internal_transfer_request)
