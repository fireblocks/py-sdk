...
with fireblocks_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Add an asset to an external wallet.
        api_response = api_instance.add_asset_to_external_wallet(wallet_id, asset_id, idempotency_key=idempotency_key, add_asset_to_external_wallet_request=add_asset_to_external_wallet_request)
...
with fireblocks_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Create an external wallet
        api_response = api_instance.create_external_wallet(idempotency_key=idempotency_key, create_wallet_request=create_wallet_request)
...
with fireblocks_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Find an external wallet
        api_response = api_instance.get_external_wallet(wallet_id)
...
with fireblocks_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Get an asset from an external wallet
        api_response = api_instance.get_external_wallet_asset(wallet_id, asset_id)
...
with fireblocks_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Set an AML customer reference ID for an external wallet
        api_instance.set_external_wallet_customer_ref_id(wallet_id, set_customer_ref_id_request, idempotency_key=idempotency_key)
    except Exception as e:
