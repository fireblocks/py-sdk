...
with fireblocks_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Create an internal wallet
        api_response = api_instance.create_internal_wallet(idempotency_key=idempotency_key, create_wallet_request=create_wallet_request)
...
with fireblocks_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Add an asset to an internal wallet
        api_response = api_instance.create_internal_wallet_asset(wallet_id, asset_id, idempotency_key=idempotency_key, create_internal_wallet_asset_request=create_internal_wallet_asset_request)
...
with fireblocks_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Get assets for internal wallet
        api_response = api_instance.get_internal_wallet(wallet_id)
...
with fireblocks_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Set an AML/KYT customer reference ID for an internal wallet
        api_instance.set_customer_ref_id_for_internal_wallet(wallet_id, set_customer_ref_id_request, idempotency_key=idempotency_key)
    except Exception as e:
