...
with fireblocks_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Create a payout instruction set
        api_response = api_instance.create_payout(idempotency_key=idempotency_key, create_payout_request=create_payout_request)
...
with fireblocks_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Execute a payout instruction set
        api_response = api_instance.execute_payout_action(payout_id, idempotency_key=idempotency_key)
