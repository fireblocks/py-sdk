...
with fireblocks_client.ApiClient(configuration) as api_client:
    ...
    api_instance = fireblocks_client.TokenizationApi(api_client)
    id = 'fbfbfbfb-fbfb-fbfb-fbfb-fbfbfbfbfbfb' # str | The token link id

    try:
        # Return a linked token
        api_response = api_instance.get_linked_token(id)
...
with fireblocks_client.ApiClient(configuration) as api_client:
    ...
    try:
        # List all linked tokens
        api_response = api_instance.get_linked_tokens(page_cursor=page_cursor, page_size=page_size, status=status)
...
with fireblocks_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Issue a new token
        api_response = api_instance.issue_new_token(create_token_request_dto, idempotency_key=idempotency_key)
...
with fireblocks_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Link a token
        api_response = api_instance.link(token_link_request_dto, idempotency_key=idempotency_key)
