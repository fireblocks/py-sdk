...
**treat_as_gross_amount** | **bool** | For transactions initiated via this Fireblocks workspace, when set to &#x60;true&#x60;, the fee is deducted from the requested amount. | [optional] 
...
**signed_messages** | [**SignedMessage**](SignedMessage.md) |  | [optional] 
