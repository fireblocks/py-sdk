...
with fireblocks_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Add jsonDidKey to VASP details
        api_response = api_instance.update_vasp(travel_rule_update_vasp_details, idempotency_key=idempotency_key)
...
with fireblocks_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Validate Full Travel Rule Transaction
        api_response = api_instance.validate_full_travel_rule_transaction(travel_rule_validate_full_transaction_request, idempotency_key=idempotency_key)
...
with fireblocks_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Validate Travel Rule Transaction
        api_response = api_instance.validate_travel_rule_transaction(travel_rule_validate_transaction_request, idempotency_key=idempotency_key)
