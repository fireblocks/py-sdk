# fireblocks_client.model.source_transfer_peer_path_response.SourceTransferPeerPathResponse
...
[all_of_1](#all_of_1) | dict, frozendict.frozendict,  | frozendict.frozendict,  | The transaction’s source. | 
...
Input Type | Accessed Type | Description | Notes
------------ | ------------- | ------------- | -------------
dict, frozendict.frozendict,  | frozendict.frozendict,  | The transaction’s source. | 
