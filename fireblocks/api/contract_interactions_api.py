...
class ContractInteractionsApi:
    ...
    def get_contract_address(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> Future[ApiResponse[ContractAddressResponse]]:
        ...
        validate_not_empty_string(function_name="get_contract_address", param_name="base_asset_id", param_value=base_asset_id)
        validate_not_empty_string(function_name="get_contract_address", param_name="tx_hash", param_value=tx_hash)

        _param = self._get_contract_address_serialize(
            base_asset_id=base_asset_id,
            tx_hash=tx_hash,
            idempotency_key=idempotency_key,
            _request_auth=_request_auth,
    ...
    def _get_contract_address_serialize(
        self,
        base_asset_id,
        tx_hash,
        idempotency_key,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/contract_interactions/base_asset_id/{baseAssetId}/tx_hash/{txHash}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
