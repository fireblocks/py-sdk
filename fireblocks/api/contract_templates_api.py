...
class ContractTemplatesApi:
    ...
    def get_contract_templates(
        ...
        initialization_phase: Annotated[Optional[StrictStr], Field(description="For standalone contracts use ON_DEPLOYMENT and for contracts that are behind proxies use POST_DEPLOYMENT")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :type type: str
        :param initialization_phase: For standalone contracts use ON_DEPLOYMENT and for contracts that are behind proxies use POST_DEPLOYMENT
    ...
    @validate_call
    def get_supported_blockchains_by_template_id(
        self,
        contract_template_id: Annotated[StrictStr, Field(description="The Contract Template identifier")],
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> Future[ApiResponse[SupportedBlockChainsResponse]]:
        ...
        validate_not_empty_string(function_name="get_supported_blockchains_by_template_id", param_name="contract_template_id", param_value=contract_template_id)

        _param = self._get_supported_blockchains_by_template_id_serialize(
            contract_template_id=contract_template_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "SupportedBlockChainsResponse",
            '404': "HttpContractDoesNotExistError",
            'default': "ErrorSchema",
        }
    ...
    def _get_supported_blockchains_by_template_id_serialize(
        self,
        contract_template_id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/tokenization/templates/{contractTemplateId}/supported_blockchains',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
