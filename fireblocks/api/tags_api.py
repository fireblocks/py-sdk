...
class TagsApi:
    ...
    def get_approval_request(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> Future[ApiResponse[ApprovalRequest]]:
        ...
        validate_not_empty_string(function_name="get_approval_request", param_name="id", param_value=id)

        _param = self._get_approval_request_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    def _get_approval_request_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/tags/approval_requests/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_tags(
        ...
        :param include_pending_approvals_info: Whether to include pending approval requests info.
    ...
    def _get_tags_serialize(
        ...
        if include_pending_approvals_info is not None:
            
            _query_params.append(('includePendingApprovalsInfo', include_pending_approvals_info))
