...
class TravelRuleApi:
    ...
    @validate_call
    def create_trust_proof_of_address(
        self,
    ...
    ) -> Future[ApiResponse[TrustProofOfAddressCreateResponse]]:
        """Create Trust Network Proof of Address

        Creates a cryptographic proof of address ownership for TRUST network.

        :param trust_proof_of_address_request: (required)
        :type trust_proof_of_address_request: TrustProofOfAddressRequest
        ...
        _param = self._create_trust_proof_of_address_serialize(
            trust_proof_of_address_request=trust_proof_of_address_request,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '201': "TrustProofOfAddressCreateResponse",
            'default': "ErrorSchema",
        }
    ...
    def _create_trust_proof_of_address_serialize(
        self,
        ...
        if trust_proof_of_address_request is not None:
            _body_params = trust_proof_of_address_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/screening/travel_rule/providers/trust/proof_of_address',
    ...
    @validate_call
    def get_trust_proof_of_address(
        self,
        transaction_id: Annotated[StrictStr, Field(description="Fireblocks transaction ID (UUID format)")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> Future[ApiResponse[TrustProofOfAddressResponse]]:
        ...
        :param transaction_id: Fireblocks transaction ID (UUID format) (required)
        ...
        validate_not_empty_string(function_name="get_trust_proof_of_address", param_name="transaction_id", param_value=transaction_id)

        _param = self._get_trust_proof_of_address_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "TrustProofOfAddressResponse",
            'default': "ErrorSchema",
        }
    ...
    def _get_trust_proof_of_address_serialize(
        self,
        transaction_id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/screening/travel_rule/providers/trust/proof_of_address/{transactionId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
