...
class VaultsApi:
    ...
    def get_asset_wallets(
        ...
        asset_id: Annotated[Optional[StrictStr], Field(description="When specified, only vault wallets with the specified ID are returned.")] = None,
        ...
        limit: Annotated[Optional[Union[Annotated[float, Field(le=1000, strict=True, ge=1)], Annotated[int, Field(le=1000, strict=True, ge=1)]]], Field(description="The maximum number of vault wallets in a single response.   The default is 200 and the maximum is 1000. ")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param asset_id: When specified, only vault wallets with the specified ID are returned.
        :type asset_id: str
        :param order_by:
        :type order_by: str
        ...
        :type after: str
        :param limit: The maximum number of vault wallets in a single response.   The default is 200 and the maximum is 1000. 
        :type limit: float
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
    ...
    def get_max_bip_index_used(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> Future[ApiResponse[GetMaxBipIndexUsedResponse]]:
        ...
        validate_not_empty_string(function_name="get_max_bip_index_used", param_name="vault_account_id", param_value=vault_account_id)
        validate_not_empty_string(function_name="get_max_bip_index_used", param_name="asset_id", param_value=asset_id)

        _param = self._get_max_bip_index_used_serialize(
            vault_account_id=vault_account_id,
            asset_id=asset_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "GetMaxBipIndexUsedResponse",
            'default': "ErrorSchema",
        }
    ...
    def _get_max_bip_index_used_serialize(
        self,
        vault_account_id,
        asset_id,
        _request_auth,
    ...
    def get_paged_vault_accounts(
        ...
        tag_ids: Annotated[Optional[Annotated[List[StrictStr], Field(max_length=50)]], Field(description="DEPRECATED - use includeTagIds instead")] = None,
        include_tag_ids: Annotated[Optional[Annotated[List[StrictStr], Field(max_length=50)]], Field(description="List of tag IDs to include. Vault accounts with any of these tags will be included")] = None,
        exclude_tag_ids: Annotated[Optional[Annotated[List[StrictStr], Field(max_length=50)]], Field(description="List of tag IDs to exclude. Vault accounts with any of these tags will be filtered out")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param limit:
        :type limit: float
        :param tag_ids: DEPRECATED - use includeTagIds instead
        :type tag_ids: List[str]
        :param include_tag_ids: List of tag IDs to include. Vault accounts with any of these tags will be included
        :type include_tag_ids: List[str]
        :param exclude_tag_ids: List of tag IDs to exclude. Vault accounts with any of these tags will be filtered out
