...
class WebhooksV2Api:
    ...
    def _create_webhook_o_auth_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/webhooks_settings/oauth',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def delete_webhook_o_auth(
        ...
        :param force_delete: Delete the credentials even while webhooks still reference them, detaching those webhooks instead of refusing. Leave it unset, or `false`, to get a `409 Conflict` whenever anything still references the credentials.
    ...
    def _delete_webhook_o_auth_serialize(
        ...
        # process the path parameters
        if webhook_oauth_id is not None:
            _path_params['webhookOauthId'] = webhook_oauth_id
        # process the query parameters
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/webhooks_settings/oauth/{webhookOauthId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def get_resend_by_query_job_status(
        self,
        ...
        validate_not_empty_string(function_name="get_resend_by_query_job_status", param_name="webhook_id", param_value=webhook_id)
        validate_not_empty_string(function_name="get_resend_by_query_job_status", param_name="job_id", param_value=job_id)

        _param = self._get_resend_by_query_job_status_serialize(
            webhook_id=webhook_id,
            job_id=job_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    def _get_resend_by_query_job_status_serialize(
        self,
        webhook_id,
        job_id,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/webhooks/{webhookId}/notifications/resend_by_query/jobs/{jobId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def resend_notifications_by_query(
        self,
        webhook_id: Annotated[StrictStr, Field(description="The ID of the webhook")],
        resend_by_query_request: ResendByQueryRequest,
        idempotency_key: Annotated[Optional[StrictStr], Field(description="A unique identifier for the request. If the request is sent multiple times with the same idempotency key, the server will return the same response as the first request. The idempotency key is valid for 24 hours.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> Future[ApiResponse[ResendByQueryResponse]]:
        ...
        :param webhook_id: The ID of the webhook (required)
        :type webhook_id: str
        :param resend_by_query_request: (required)
        :type resend_by_query_request: ResendByQueryRequest
        :param idempotency_key: A unique identifier for the request. If the request is sent multiple times with the same idempotency key, the server will return the same response as the first request. The idempotency key is valid for 24 hours.
        :type idempotency_key: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
        ...
        validate_not_empty_string(function_name="resend_notifications_by_query", param_name="webhook_id", param_value=webhook_id)

        _param = self._resend_notifications_by_query_serialize(
            webhook_id=webhook_id,
            resend_by_query_request=resend_by_query_request,
            idempotency_key=idempotency_key,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "ResendByQueryResponse",
            '202': "ResendByQueryResponse",
            'default': "ErrorSchema",
        }
    ...
    def _resend_notifications_by_query_serialize(
        self,
        webhook_id,
        resend_by_query_request,
        idempotency_key,
        _request_auth,
        _content_type,
        _headers,
        ...
        # process the form parameters
        # process the body parameter
        if resend_by_query_request is not None:
            _body_params = resend_by_query_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/webhooks/{webhookId}/notifications/resend_by_query',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
