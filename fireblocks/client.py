...
class Fireblocks:
    ...
    def onchain_data(self) -> OnchainDataApi:
        if self._onchain_data is None:
            self._onchain_data = OnchainDataApi(self._api_client)
    ...
    @property
    def tr_link(self) -> TRLinkApi:
        if self._tr_link is None:
            self._tr_link = TRLinkApi(self._api_client)
        return self._tr_link
