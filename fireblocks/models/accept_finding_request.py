...
class AcceptFindingRequest(BaseModel):
    ...
    """ # noqa: E501
    status: StrictStr = Field(description="Marks the finding as accepted.")
    status_updated_reason: Annotated[str, Field(min_length=1, strict=True)] = Field(description="The reason for accepting the finding.", alias="statusUpdatedReason")
    __properties: ClassVar[List[str]] = ["status", "statusUpdatedReason"]
