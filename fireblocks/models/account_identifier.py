...
class AccountIdentifier(BaseModel):
    ...
    sub_type: Optional[StrictStr] = Field(default=None, description="Account subtype", alias="subType")
    address: Optional[StrictStr] = Field(default=None, description="Account address")
