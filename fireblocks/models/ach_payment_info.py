...
class AchPaymentInfo(BaseModel):
    """
    ACH payment information for US Automated Clearing House transfers
    """ # noqa: E501
    rail: StrictStr = Field(description="The payment rail type for ACH transfers")
    addressing_system: StrictStr = Field(description="The addressing system used for ACH transfers", alias="addressingSystem")
    ...
    account_type: StrictStr = Field(description="The type of bank account", alias="accountType")
    __properties: ClassVar[List[str]] = ["rail", "addressingSystem", "accountHolderGivenName", "accountHolderSurname", "country", "accountNumber", "routingNumber", "accountType"]
