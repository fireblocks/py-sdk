...
class AddConnectedAccountResponse(BaseModel):
    """
    AddConnectedAccountResponse
    """ # noqa: E501
    accounts: List[AddedConnectedAccountItem] = Field(description="Created accounts — main account first, sub-accounts after (NLV2 hierarchy).")
