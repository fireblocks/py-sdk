...
class AdditionalInfoRequest(BaseModel):
    ...
    """ # noqa: E501
    additional_info: AdditionalInfoRequestAdditionalInfo = Field(alias="additionalInfo")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "additionalInfo": AdditionalInfoRequestAdditionalInfo.from_dict(obj["additionalInfo"]) if obj.get("additionalInfo") is not None else None
        })
        return _obj
