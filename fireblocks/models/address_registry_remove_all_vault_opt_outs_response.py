...
class AddressRegistryRemoveAllVaultOptOutsResponse(BaseModel):
    """
    Result of clearing all vault-level opt-outs for the address registry on this workspace.
    """ # noqa: E501
    removed_count: StrictInt = Field(description="Number of opt-out rows deleted (0 if none existed).", alias="removedCount")
    __properties: ClassVar[List[str]] = ["removedCount"]
