...
class AddressRegistryRemoveVaultOptOutResponse(BaseModel):
    """
    Body after removing one vault from the opt-out list; same fields as GET for that vault (`optedOut` is false).
    """ # noqa: E501
    opted_out: StrictBool = Field(description="Always false after a successful remove — the vault is not on the opt-out list.", alias="optedOut")
