...
class AmlVerdictManualRequest(BaseModel):
    """
    AmlVerdictManualRequest
    """ # noqa: E501
    verdict: StrictStr = Field(description="The AML verdict to set for the transaction")
    tx_id: StrictStr = Field(description="The transaction ID to set the verdict for", alias="txId")
    __properties: ClassVar[List[str]] = ["verdict", "txId"]
