...
class ChannelDvnConfigWithConfirmations(BaseModel):
    """
    ChannelDvnConfigWithConfirmations
    """ # noqa: E501
    send_config: Optional[ChannelDvnConfigWithConfirmationsSendConfig] = Field(default=None, alias="sendConfig")
    receive_config: Optional[ChannelDvnConfigWithConfirmationsReceiveConfig] = Field(default=None, alias="receiveConfig")
    __properties: ClassVar[List[str]] = ["sendConfig", "receiveConfig"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "sendConfig": ChannelDvnConfigWithConfirmationsSendConfig.from_dict(obj["sendConfig"]) if obj.get("sendConfig") is not None else None,
            "receiveConfig": ChannelDvnConfigWithConfirmationsReceiveConfig.from_dict(obj["receiveConfig"]) if obj.get("receiveConfig") is not None else None
        })
        return _obj
