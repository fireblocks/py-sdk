...
class ConnectedAccountRateResponse(BaseModel):
    """
    ConnectedAccountRateResponse
    """ # noqa: E501
    account_id: StrictStr = Field(description="The ID of the account that generated the quote.", alias="accountId")
    ...
    rate: StrictStr = Field(description="The exchange rate value")
    __properties: ClassVar[List[str]] = ["accountId", "baseAssetId", "quoteAssetId", "rate"]
