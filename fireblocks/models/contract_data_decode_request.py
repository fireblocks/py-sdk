...
class ContractDataDecodeRequest(BaseModel):
    """
    ContractDataDecodeRequest
    """ # noqa: E501
    data: ContractDataDecodeRequestData
    data_type: ContractDataDecodeDataType = Field(alias="dataType")
    abi: Optional[List[AbiFunction]] = Field(default=None, description="The abi of the function/error/log to decode.")
    __properties: ClassVar[List[str]] = ["data", "dataType", "abi"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": ContractDataDecodeRequestData.from_dict(obj["data"]) if obj.get("data") is not None else None,
