...
class ContractDataDecodedResponse(BaseModel):
    """
    ContractDataDecodedResponse
    """ # noqa: E501
    result: List[ContractDataDecodeResponseParams] = Field(description="The decoded parameters of the contract function call.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "result": [ContractDataDecodeResponseParams.from_dict(_item) for _item in obj["result"]] if obj.get("result") is not None else None,
            "type": obj.get("type")
        })
        return _obj
