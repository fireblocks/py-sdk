...
class CreateMultichainTokenRequest(BaseModel):
    """
    ...
    create_params: CreateMultichainTokenRequestCreateParams = Field(alias="createParams")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "createParams": CreateMultichainTokenRequestCreateParams.from_dict(obj["createParams"]) if obj.get("createParams") is not None else None,
            "salt": obj.get("salt"),
