...
class CreateMultichainTokenRequestDto(BaseModel):
    """
    ...
    create_params: CreateMultichainTokenRequestDtoCreateParams = Field(alias="createParams")
    ...
    chains: List[StrictStr] = Field(description="The base asset identifiers of the blockchains (legacyId) to calculate deterministic addresses")
    ...
    __properties: ClassVar[List[str]] = ["vaultAccountId", "createParams", "salt", "chains", "displayName", "useGasless", "fee", "feeLevel"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "createParams": CreateMultichainTokenRequestDtoCreateParams.from_dict(obj["createParams"]) if obj.get("createParams") is not None else None,
            "salt": obj.get("salt"),
