...
class EarnAsset(BaseModel):
    ...
    EarnAsset
    """ # noqa: E501
    address: Optional[StrictStr] = Field(default=None, description="Contract address of the token on-chain.")
    ...
    asset_id: Optional[StrictStr] = Field(default=None, description="Fireblocks legacy asset identifier (e.g. USDC_ETH, PYUSD).", alias="assetId")
    __properties: ClassVar[List[str]] = ["address", "symbol", "decimals", "assetId"]
