...
class ExecutionResponseDetails(BaseModel):
    ...
    """
    # data type: MarketExecutionResponseDetails
    ...
    def actual_instance_must_validate_oneof(cls, v):
        instance = ExecutionResponseDetails.model_construct()
        error_messages = []
        match = 0
        # validate data type: MarketExecutionResponseDetails
        if not isinstance(v, MarketExecutionResponseDetails):
            error_messages.append(f"Error! Input type `{type(v)}` is not `MarketExecutionResponseDetails`")
        else:
            match += 1
        # validate data type: QuoteExecutionWithRequoteResponseDetails
        if not isinstance(v, QuoteExecutionWithRequoteResponseDetails):
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        # deserialize data into MarketExecutionResponseDetails
        try:
            instance.actual_instance = MarketExecutionResponseDetails.from_json(json_str)
            match += 1
        except (ValidationError, ValueError) as e:
            error_messages.append(str(e))
        # deserialize data into QuoteExecutionWithRequoteResponseDetails
        try:
            instance.actual_instance = QuoteExecutionWithRequoteResponseDetails.from_json(json_str)
            match += 1
        except (ValidationError, ValueError) as e:
            error_messages.append(str(e))
