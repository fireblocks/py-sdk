...
class FiatDestination(BaseModel):
    ...
    def actual_instance_must_validate_oneof(cls, v):
        ...
        if not isinstance(v, MobileMoneyDestination):
            ...
            match += 1
        # validate data type: EuropeanSEPADestination
        if not isinstance(v, EuropeanSEPADestination):
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        try:
            ...
            error_messages.append(str(e))
        # deserialize data into EuropeanSEPADestination
        try:
            instance.actual_instance = EuropeanSEPADestination.from_json(json_str)
            match += 1
        except (ValidationError, ValueError) as e:
            error_messages.append(str(e))
