...
class GetAutomationSettingsResponse(BaseModel):
    """
    GetAutomationSettingsResponse
    """ # noqa: E501
    settings: List[AutomationSettingsResponse] = Field(description="The deposit automations configured for the vault account.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "settings": [AutomationSettingsResponse.from_dict(_item) for _item in obj["settings"]] if obj.get("settings") is not None else None
        })
        return _obj
