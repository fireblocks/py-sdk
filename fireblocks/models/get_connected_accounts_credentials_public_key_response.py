...
class GetConnectedAccountsCredentialsPublicKeyResponse(BaseModel):
    """
    GetConnectedAccountsCredentialsPublicKeyResponse
    """ # noqa: E501
    public_key: StrictStr = Field(description="RSA public key (PEM) used to encrypt credential payloads sent to POST /connected_accounts.", alias="publicKey")
