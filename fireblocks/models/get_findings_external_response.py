...
class GetFindingsExternalResponse(BaseModel):
    ...
    next: Optional[StrictStr] = Field(default=None, description="Cursor for the next page of results, omitted when there are no more results.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [SecurityFinding.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
            "total": obj.get("total"),
            "next": obj.get("next")
        })
        return _obj
