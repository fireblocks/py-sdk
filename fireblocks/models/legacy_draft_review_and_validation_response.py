...
class LegacyDraftReviewAndValidationResponse(BaseModel):
    """
    Draft validation
    """ # noqa: E501
    draft_response: LegacyDraftResponse = Field(alias="draftResponse")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "draftResponse": LegacyDraftResponse.from_dict(obj["draftResponse"]) if obj.get("draftResponse") is not None else None,
            "validation": LegacyPolicyValidation.from_dict(obj["validation"]) if obj.get("validation") is not None else None
        })
        return _obj
