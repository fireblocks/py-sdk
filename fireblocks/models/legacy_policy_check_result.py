...
class LegacyPolicyCheckResult(BaseModel):
    """
    Policy rules validation result
    """ # noqa: E501
    errors: Union[StrictFloat, StrictInt] = Field(description="Number of errors")
    results: List[LegacyPolicyRuleCheckResult] = Field(description="A set of validation results")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "results": [LegacyPolicyRuleCheckResult.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None
        })
        return _obj
