...
class LegacyPolicyRuleAmountAggregation(BaseModel):
    """
    ...
    """ # noqa: E501
    operators: Optional[LegacyAmountAggregationTimePeriodMethod] = None
    src_transfer_peers: Optional[LegacyAmountAggregationTimePeriodMethod] = Field(default=None, alias="srcTransferPeers")
    dst_transfer_peers: Optional[LegacyAmountAggregationTimePeriodMethod] = Field(default=None, alias="dstTransferPeers")
