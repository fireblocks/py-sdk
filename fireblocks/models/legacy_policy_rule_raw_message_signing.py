...
class LegacyPolicyRuleRawMessageSigning(BaseModel):
    """
    Raw message signing configuration
    """ # noqa: E501
    algorithm: Optional[StrictStr] = None
    derivation_path: Optional[LegacyPolicyRuleRawMessageSigningDerivationPath] = Field(default=None, alias="derivationPath")
    __properties: ClassVar[List[str]] = ["algorithm", "derivationPath"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "derivationPath": LegacyPolicyRuleRawMessageSigningDerivationPath.from_dict(obj["derivationPath"]) if obj.get("derivationPath") is not None else None
        })
        return _obj
