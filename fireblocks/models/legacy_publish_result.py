...
class LegacyPublishResult(BaseModel):
    ...
    check_result: LegacyPolicyCheckResult = Field(alias="checkResult")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "rules": [LegacyPolicyRule.from_dict(_item) for _item in obj["rules"]] if obj.get("rules") is not None else None,
            "checkResult": LegacyPolicyCheckResult.from_dict(obj["checkResult"]) if obj.get("checkResult") is not None else None,
            "metadata": LegacyPolicyMetadata.from_dict(obj["metadata"]) if obj.get("metadata") is not None else None
        })
        return _obj
