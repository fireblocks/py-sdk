...
class ListUtxosResponse(BaseModel):
    ...
    ListUtxosResponse
    """ # noqa: E501
    data: List[UtxoOutput] = Field(description="List of UTXOs")
    next: Optional[StrictStr] = Field(default=None, description="Cursor to the next page")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [UtxoOutput.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
            "next": obj.get("next")
        })
        return _obj
