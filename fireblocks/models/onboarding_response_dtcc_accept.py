...
class OnboardingResponseDtccAccept(BaseModel):
    """
    ...
    def response_type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['DTCC_END_INVESTOR_ONBOARDING_ACCEPT']):
            raise ValueError("must be one of enum values ('DTCC_END_INVESTOR_ONBOARDING_ACCEPT')")
        return value
