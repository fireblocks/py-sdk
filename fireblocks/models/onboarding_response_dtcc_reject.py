...
class OnboardingResponseDtccReject(BaseModel):
    """
    ...
    def response_type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['DTCC_END_INVESTOR_ONBOARDING_REJECT']):
            raise ValueError("must be one of enum values ('DTCC_END_INVESTOR_ONBOARDING_REJECT')")
        return value
