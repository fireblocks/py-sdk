...
class OnboardingResponseTradewebAccept(BaseModel):
    """
    ...
    def response_type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['TRADEWEB_COSIGNING_DELEGATION_ACCEPT']):
            raise ValueError("must be one of enum values ('TRADEWEB_COSIGNING_DELEGATION_ACCEPT')")
        return value
