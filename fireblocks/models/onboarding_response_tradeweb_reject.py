...
class OnboardingResponseTradewebReject(BaseModel):
    """
    ...
    def response_type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['TRADEWEB_COSIGNING_DELEGATION_REJECT']):
            raise ValueError("must be one of enum values ('TRADEWEB_COSIGNING_DELEGATION_REJECT')")
        return value
