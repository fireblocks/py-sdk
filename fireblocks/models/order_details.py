...
class OrderDetails(BaseModel):
    ...
    execution_steps: List[OrderExecutionStep] = Field(alias="executionSteps")
    ...
    __properties: ClassVar[List[str]] = ["id", "via", "status", "createdAt", "updatedAt", "receipt", "generalFees", "executionSteps", "executionResponseDetails", "settlement", "participantsIdentification", "paymentInstructions", "createdBy", "customerInternalReferenceId", "note", "expiresAt", "failure"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "executionSteps": [OrderExecutionStep.from_dict(_item) for _item in obj["executionSteps"]] if obj.get("executionSteps") is not None else None,
