...
class PaginatedAssetsResponse(BaseModel):
    ...
    """ # noqa: E501
    total: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Total number of assets in the internal wallet")
    data: UnmanagedWallet
    next: Optional[StrictStr] = Field(default=None, description="Cursor for the next page of results")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "total": obj.get("total"),
            "data": UnmanagedWallet.from_dict(obj["data"]) if obj.get("data") is not None else None,
            "next": obj.get("next")
        })
        return _obj
