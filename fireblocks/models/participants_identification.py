...
class ParticipantsIdentification(BaseModel):
    """
    KYC/AML participant identification
    """ # noqa: E501
    originator: Optional[Identification] = None
    beneficiary: Optional[Identification] = None
    __properties: ClassVar[List[str]] = ["originator", "beneficiary"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "originator": Identification.from_dict(obj["originator"]) if obj.get("originator") is not None else None,
            "beneficiary": Identification.from_dict(obj["beneficiary"]) if obj.get("beneficiary") is not None else None
        })
        return _obj
