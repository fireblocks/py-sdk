...
class PesonetPaymentInfo(BaseModel):
    """
    PesoNet payment information for Philippine batch payment transfers (PHP)
    """ # noqa: E501
    rail: StrictStr = Field(description="The payment rail type for PesoNet transfers")
    addressing_system: StrictStr = Field(description="The addressing system used for PesoNet transfers", alias="addressingSystem")
