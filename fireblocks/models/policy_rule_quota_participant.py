...
class PolicyRuleQuotaParticipant(BaseModel):
    """
    Participant identifier for AOT quota calculation
    """ # noqa: E501
    id: StrictStr = Field(description="Participant identifier (integer for VAULT accounts, UUID for others)")
    type: StrictStr = Field(description="Participant type")
