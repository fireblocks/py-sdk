...
class PostalAddress(BaseModel):
    ...
    PostalAddress
    """ # noqa: E501
    street_name: StrictStr = Field(alias="streetName")
    building_number: StrictStr = Field(alias="buildingNumber")
    postal_code: StrictStr = Field(alias="postalCode")
    city: StrictStr
    subdivision: StrictStr
    district: StrictStr
    country: StrictStr
    __properties: ClassVar[List[str]] = ["streetName", "buildingNumber", "postalCode", "city", "subdivision", "district", "country"]
