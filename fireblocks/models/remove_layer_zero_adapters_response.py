...
class RemoveLayerZeroAdaptersResponse(BaseModel):
    """
    RemoveLayerZeroAdaptersResponse
    """ # noqa: E501
    deactivated: List[StrictStr] = Field(description="List of successfully deactivated adapter token link IDs")
    failed: List[RemoveLayerZeroAdapterFailedResult] = Field(description="List of adapter token link IDs that failed to be removed")
    __properties: ClassVar[List[str]] = ["deactivated", "failed"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "failed": [RemoveLayerZeroAdapterFailedResult.from_dict(_item) for _item in obj["failed"]] if obj.get("failed") is not None else None
        })
        return _obj
