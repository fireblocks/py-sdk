...
class ReopenFindingRequest(BaseModel):
    ...
    """ # noqa: E501
    status: StrictStr = Field(description="Marks the finding as open again.")
    status_updated_reason: Optional[StrictStr] = Field(default=None, description="Ignored when reopening a finding.", alias="statusUpdatedReason")
