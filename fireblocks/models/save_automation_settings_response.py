...
class SaveAutomationSettingsResponse(BaseModel):
    """
    SaveAutomationSettingsResponse
    """ # noqa: E501
    automation_id: StrictStr = Field(description="The ID of the newly created deposit automation.", alias="automationId")
    __properties: ClassVar[List[str]] = ["automationId"]
