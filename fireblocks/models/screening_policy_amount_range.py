...
class ScreeningPolicyAmountRange(BaseModel):
    """
    Minimum and maximum amount range specification
    """ # noqa: E501
    min: Optional[StrictStr] = Field(default=None, description="Minimum amount (inclusive)")
    max: Optional[StrictStr] = Field(default=None, description="Maximum amount (inclusive)")
