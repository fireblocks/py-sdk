...
class SolanaInstruction(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "accounts": [SOLAccount.from_dict(_item) for _item in obj["accounts"]] if obj.get("accounts") is not None else None,
            "args": [SolParameter.from_dict(_item) for _item in obj["args"]] if obj.get("args") is not None else None
        })
        return _obj
