...
class SplitRequest(BaseModel):
    ...
    SplitRequest
    """ # noqa: E501
    id: StrictStr = Field(description="id of position to split")
    amount: StrictStr = Field(description="Amount of tokens to be transferred to the new stake account.")
    ...
    tx_note: Optional[StrictStr] = Field(default=None, description="The note to associate with the split transactions.", alias="txNote")
    __properties: ClassVar[List[str]] = ["id", "amount", "fee", "feeLevel", "txNote"]
