...
class TRLinkAPIPagedResponse(BaseModel):
    """
    Generic paginated response wrapper with cursor-based pagination
    """ # noqa: E501
    data: List[TRLinkVaspListDto] = Field(description="Array of result items")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [TRLinkVaspListDto.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
