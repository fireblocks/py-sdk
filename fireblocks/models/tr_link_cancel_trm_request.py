...
class TRLinkCancelTrmRequest(BaseModel):
    """
    TRLinkCancelTrmRequest
    """ # noqa: E501
    reason: Optional[StrictStr] = Field(default=None, description="Reason for cancellation")
    cancelled_by: Optional[StrictStr] = Field(default=None, description="User ID who cancelled the TRM", alias="cancelledBy")
    __properties: ClassVar[List[str]] = ["reason", "cancelledBy"]
