...
class TRLinkConnectIntegrationRequest(BaseModel):
    """
    TRLinkConnectIntegrationRequest
    """ # noqa: E501
    api_key: StrictStr = Field(description="API key provided by the Travel Rule partner", alias="apiKey")
    secret: Optional[StrictStr] = Field(default=None, description="Secret/password provided by the Travel Rule partner (optional)")
