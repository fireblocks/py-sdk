...
class TRLinkGetRequiredActionsResponse(BaseModel):
    """
    Response containing the list of required actions for a TRM
    """ # noqa: E501
    actions: Annotated[List[TRLinkRequiredAction], Field(min_length=0, max_length=10)] = Field(description="List of required actions for the TRM")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "actions": [TRLinkRequiredAction.from_dict(_item) for _item in obj["actions"]] if obj.get("actions") is not None else None
        })
        return _obj
