...
class TRLinkPostScreeningRule2(BaseModel):
    """
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if provider_ident (nullable) is None
        # and model_fields_set contains the field
        if self.provider_ident is None and "provider_ident" in self.model_fields_set:
            _dict['providerIdent'] = None

        # set to None if trm_status (nullable) is None
        # and model_fields_set contains the field
        if self.trm_status is None and "trm_status" in self.model_fields_set:
            _dict['trmStatus'] = None
