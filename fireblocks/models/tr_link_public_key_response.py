...
class TRLinkPublicKeyResponse(BaseModel):
    """
    TRLinkPublicKeyResponse
    """ # noqa: E501
    issuer: StrictStr = Field(description="Partner issuer identifier")
    public_key: TRLinkJwkPublicKey = Field(alias="publicKey")
    __properties: ClassVar[List[str]] = ["issuer", "publicKey"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "publicKey": TRLinkJwkPublicKey.from_dict(obj["publicKey"]) if obj.get("publicKey") is not None else None
        })
        return _obj
