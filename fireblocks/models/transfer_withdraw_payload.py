...
class TransferWithdrawPayload(BaseModel):
    """
    ...
    offer_transaction_id: StrictStr = Field(description="The Fireblocks transaction id of the OUTGOING transfer offer being withdrawn.", alias="offerTransactionId")
    __properties: ClassVar[List[str]] = ["vaultAccountId", "asset", "offerTransactionId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "asset": obj.get("asset"),
            "offerTransactionId": obj.get("offerTransactionId")
        })
        return _obj
