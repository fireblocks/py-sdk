...
class TravelRuleNationalIdentification(BaseModel):
    ...
    """ # noqa: E501
    country_of_issue: Optional[StrictStr] = Field(default=None, alias="countryOfIssue")
    national_identifier: Optional[StrictStr] = Field(default=None, alias="nationalIdentifier")
    national_identifier_type: Optional[StrictStr] = Field(default=None, alias="nationalIdentifierType")
