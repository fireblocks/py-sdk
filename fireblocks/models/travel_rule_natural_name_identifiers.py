...
class TravelRuleNaturalNameIdentifiers(BaseModel):
    """
    TravelRuleNaturalNameIdentifiers
    """ # noqa: E501
    primary_identifier: Optional[StrictStr] = Field(default=None, alias="primaryIdentifier")
    secondary_identifier: Optional[StrictStr] = Field(default=None, alias="secondaryIdentifier")
    name_identifier_type: Optional[StrictStr] = Field(default=None, alias="nameIdentifierType")
