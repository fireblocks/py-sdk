...
class TravelRuleValidateLegalNameIdentifier(BaseModel):
    ...
    def legal_person_name_identifier_type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['LEGL', 'SHRT', 'TRAD']):
