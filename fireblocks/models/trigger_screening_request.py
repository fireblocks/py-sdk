...
class TriggerScreeningRequest(BaseModel):
    ...
    """ # noqa: E501
    workflow_id: StrictStr = Field(description="The workflow to screen against. Must be in `ACTIVE` status.", alias="workflowId")
    input: ScreeningInput
    __properties: ClassVar[List[str]] = ["workflowId", "input"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "input": ScreeningInput.from_dict(obj["input"]) if obj.get("input") is not None else None
        })
        return _obj
