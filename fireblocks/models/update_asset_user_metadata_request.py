...
class UpdateAssetUserMetadataRequest(BaseModel):
    """
    UpdateAssetUserMetadataRequest
    """ # noqa: E501
    metadata: Optional[AssetMetadataRequest] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "metadata": AssetMetadataRequest.from_dict(obj["metadata"]) if obj.get("metadata") is not None else None
        })
        return _obj
