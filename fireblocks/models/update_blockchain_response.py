...
class UpdateBlockchainResponse(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "blockchain": Blockchain.from_dict(obj["blockchain"]) if obj.get("blockchain") is not None else None,
