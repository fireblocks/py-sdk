...
class WebhookOAuthCredentials(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "clientId", "url", "authMethod", "customJwtClaims", "customBodyParams", "customHeaders", "mtlsClientSignedCert", "createdAt", "updatedAt"]
