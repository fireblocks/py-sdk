...
class AuditLogsApi:
    ...
    def get_audits_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetAuditLogsResponseDTO]:
        """Get audit logs
    ...
    @validate_call
    def get_audits_without_preload_content(
        self,
        time_period: Annotated[Optional[StrictStr], Field(description="The last time period to fetch audit logs")] = None,
        _request_timeout: Union[
            None,
