...
class ContractTemplatesApi:
    ...
    @validate_call
    def delete_contract_template_by_id_with_http_info(
        self,
        contract_template_id: Annotated[StrictStr, Field(description="The Contract Template identifier")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def delete_contract_template_by_id_without_preload_content(
        self,
        contract_template_id: Annotated[StrictStr, Field(description="The Contract Template identifier")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_constructor_by_contract_template_id_with_http_info(
        self,
        contract_template_id: Annotated[StrictStr, Field(description="The Contract Template identifier")],
        with_docs: Annotated[Optional[StrictBool], Field(description="true if you want to get the abi with its docs")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def get_constructor_by_contract_template_id_without_preload_content(
        self,
        contract_template_id: Annotated[StrictStr, Field(description="The Contract Template identifier")],
        with_docs: Annotated[Optional[StrictBool], Field(description="true if you want to get the abi with its docs")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def get_contract_template_by_id_with_http_info(
        self,
        contract_template_id: Annotated[StrictStr, Field(description="The Contract Template identifier")],
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ContractTemplateDto]:
        """Return contract template by id
    ...
    @validate_call
    def get_contract_template_by_id_without_preload_content(
        self,
        contract_template_id: Annotated[StrictStr, Field(description="The Contract Template identifier")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_function_abi_by_contract_template_id_with_http_info(
        self,
        contract_template_id: Annotated[StrictStr, Field(description="The Contract Template identifier")],
        function_signature: StrictStr,
        _request_timeout: Union[
    ...
    @validate_call
    def get_function_abi_by_contract_template_id_without_preload_content(
        self,
        contract_template_id: Annotated[StrictStr, Field(description="The Contract Template identifier")],
        function_signature: StrictStr,
        _request_timeout: Union[
    ...
    @validate_call
    def upload_contract_template_with_http_info(
        self,
        contract_upload_request: ContractUploadRequest,
        idempotency_key: Annotated[Optional[StrictStr], Field(description="A unique identifier for the request. If the request is sent multiple times with the same idempotency key, the server will return the same response as the first request. The idempotency key is valid for 24 hours.")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def upload_contract_template_without_preload_content(
        self,
        contract_upload_request: ContractUploadRequest,
        idempotency_key: Annotated[Optional[StrictStr], Field(description="A unique identifier for the request. If the request is sent multiple times with the same idempotency key, the server will return the same response as the first request. The idempotency key is valid for 24 hours.")] = None,
        _request_timeout: Union[
