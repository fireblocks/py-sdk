...
class ContractsApi:
    ...
    @validate_call
    def add_contract_asset_with_http_info(
        self,
        contract_id: Annotated[StrictStr, Field(description="The ID of the contract")],
        asset_id: Annotated[StrictStr, Field(description="The ID of the asset to add")],
        idempotency_key: Annotated[Optional[StrictStr], Field(description="A unique identifier for the request. If the request is sent multiple times with the same idempotency key, the server will return the same response as the first request. The idempotency key is valid for 24 hours.")] = None,
    ...
    @validate_call
    def add_contract_asset_without_preload_content(
        self,
        contract_id: Annotated[StrictStr, Field(description="The ID of the contract")],
        asset_id: Annotated[StrictStr, Field(description="The ID of the asset to add")],
        idempotency_key: Annotated[Optional[StrictStr], Field(description="A unique identifier for the request. If the request is sent multiple times with the same idempotency key, the server will return the same response as the first request. The idempotency key is valid for 24 hours.")] = None,
    ...
    @validate_call
    def delete_contract_asset_with_http_info(
        self,
        contract_id: Annotated[StrictStr, Field(description="The ID of the contract")],
        asset_id: Annotated[StrictStr, Field(description="The ID of the asset to delete")],
        _request_timeout: Union[
    ...
    @validate_call
    def delete_contract_asset_without_preload_content(
        self,
        contract_id: Annotated[StrictStr, Field(description="The ID of the contract")],
        asset_id: Annotated[StrictStr, Field(description="The ID of the asset to delete")],
        _request_timeout: Union[
    ...
    @validate_call
    def get_contract_asset_with_http_info(
        self,
        contract_id: Annotated[StrictStr, Field(description="The ID of the contract")],
        asset_id: Annotated[StrictStr, Field(description="The ID of the asset to return")],
        _request_timeout: Union[
    ...
    @validate_call
    def get_contract_asset_without_preload_content(
        self,
        contract_id: Annotated[StrictStr, Field(description="The ID of the contract")],
        asset_id: Annotated[StrictStr, Field(description="The ID of the asset to return")],
        _request_timeout: Union[
