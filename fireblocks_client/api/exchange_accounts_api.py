...
class ExchangeAccountsApi:
    ...
    @validate_call
    def convert_assets_with_http_info(
        self,
        exchange_account_id: Annotated[StrictStr, Field(description="The ID of the exchange account. Please make sure the exchange supports conversions. To find the ID of your exchange account, use GET/exchange_accounts.")],
        idempotency_key: Annotated[Optional[StrictStr], Field(description="A unique identifier for the request. If the request is sent multiple times with the same idempotency key, the server will return the same response as the first request. The idempotency key is valid for 24 hours.")] = None,
        convert_assets_request: Optional[ConvertAssetsRequest] = None,
    ...
    @validate_call
    def convert_assets_without_preload_content(
        self,
        exchange_account_id: Annotated[StrictStr, Field(description="The ID of the exchange account. Please make sure the exchange supports conversions. To find the ID of your exchange account, use GET/exchange_accounts.")],
        idempotency_key: Annotated[Optional[StrictStr], Field(description="A unique identifier for the request. If the request is sent multiple times with the same idempotency key, the server will return the same response as the first request. The idempotency key is valid for 24 hours.")] = None,
        convert_assets_request: Optional[ConvertAssetsRequest] = None,
    ...
    @validate_call
    def get_exchange_account_with_http_info(
        self,
        exchange_account_id: Annotated[StrictStr, Field(description="The ID of the exchange account to return")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_exchange_account_without_preload_content(
        self,
        exchange_account_id: Annotated[StrictStr, Field(description="The ID of the exchange account to return")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_exchange_account_asset_with_http_info(
        self,
        exchange_account_id: Annotated[StrictStr, Field(description="The ID of the exchange account to return")],
        asset_id: Annotated[StrictStr, Field(description="The ID of the asset to return")],
        _request_timeout: Union[
    ...
    @validate_call
    def get_exchange_account_asset_without_preload_content(
        self,
        exchange_account_id: Annotated[StrictStr, Field(description="The ID of the exchange account to return")],
        asset_id: Annotated[StrictStr, Field(description="The ID of the asset to return")],
        _request_timeout: Union[
    ...
    @validate_call
    def get_paged_exchange_accounts_with_http_info(
        self,
        limit: Annotated[Union[Annotated[float, Field(le=5, strict=True, ge=1)], Annotated[int, Field(le=5, strict=True, ge=1)]], Field(description="number of exchanges per page")],
        before: Optional[StrictStr] = None,
        after: Optional[StrictStr] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[ExchangeAccountsPaged]]:
        """Pagination list exchange accounts
    ...
    @validate_call
    def get_paged_exchange_accounts_without_preload_content(
        self,
        limit: Annotated[Union[Annotated[float, Field(le=5, strict=True, ge=1)], Annotated[int, Field(le=5, strict=True, ge=1)]], Field(description="number of exchanges per page")],
        before: Optional[StrictStr] = None,
        after: Optional[StrictStr] = None,
    ...
    @validate_call
    def internal_transfer_with_http_info(
        self,
        exchange_account_id: Annotated[StrictStr, Field(description="The ID of the exchange account to return")],
        idempotency_key: Annotated[Optional[StrictStr], Field(description="A unique identifier for the request. If the request is sent multiple times with the same idempotency key, the server will return the same response as the first request. The idempotency key is valid for 24 hours.")] = None,
        create_internal_transfer_request: Optional[CreateInternalTransferRequest] = None,
    ...
    @validate_call
    def internal_transfer_without_preload_content(
        self,
        exchange_account_id: Annotated[StrictStr, Field(description="The ID of the exchange account to return")],
        idempotency_key: Annotated[Optional[StrictStr], Field(description="A unique identifier for the request. If the request is sent multiple times with the same idempotency key, the server will return the same response as the first request. The idempotency key is valid for 24 hours.")] = None,
        create_internal_transfer_request: Optional[CreateInternalTransferRequest] = None,
