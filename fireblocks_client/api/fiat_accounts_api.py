...
class FiatAccountsApi:
    ...
    @validate_call
    def deposit_funds_from_linked_dda_with_http_info(
        self,
        account_id: Annotated[StrictStr, Field(description="The ID of the fiat account to use")],
        idempotency_key: Annotated[Optional[StrictStr], Field(description="A unique identifier for the request. If the request is sent multiple times with the same idempotency key, the server will return the same response as the first request. The idempotency key is valid for 24 hours.")] = None,
        funds: Optional[Funds] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[DepositFundsFromLinkedDDAResponse]:
        """Deposit funds from DDA
    ...
    @validate_call
    def deposit_funds_from_linked_dda_without_preload_content(
        self,
        account_id: Annotated[StrictStr, Field(description="The ID of the fiat account to use")],
        idempotency_key: Annotated[Optional[StrictStr], Field(description="A unique identifier for the request. If the request is sent multiple times with the same idempotency key, the server will return the same response as the first request. The idempotency key is valid for 24 hours.")] = None,
        funds: Optional[Funds] = None,
    ...
    @validate_call
    def get_fiat_account_with_http_info(
        self,
        account_id: Annotated[StrictStr, Field(description="The ID of the fiat account to return")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_fiat_account_without_preload_content(
        self,
        account_id: Annotated[StrictStr, Field(description="The ID of the fiat account to return")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_fiat_accounts_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def get_fiat_accounts_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def redeem_funds_to_linked_dda_with_http_info(
        self,
        account_id: Annotated[StrictStr, Field(description="The ID of the fiat account to use")],
        idempotency_key: Annotated[Optional[StrictStr], Field(description="A unique identifier for the request. If the request is sent multiple times with the same idempotency key, the server will return the same response as the first request. The idempotency key is valid for 24 hours.")] = None,
        funds: Optional[Funds] = None,
    ...
    @validate_call
    def redeem_funds_to_linked_dda_without_preload_content(
        self,
        account_id: Annotated[StrictStr, Field(description="The ID of the fiat account to use")],
        idempotency_key: Annotated[Optional[StrictStr], Field(description="A unique identifier for the request. If the request is sent multiple times with the same idempotency key, the server will return the same response as the first request. The idempotency key is valid for 24 hours.")] = None,
        funds: Optional[Funds] = None,
