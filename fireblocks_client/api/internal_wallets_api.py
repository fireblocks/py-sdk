...
class InternalWalletsApi:
    ...
    @validate_call
    def create_internal_wallet_with_http_info(
        self,
        idempotency_key: Annotated[Optional[StrictStr], Field(description="A unique identifier for the request. If the request is sent multiple times with the same idempotency key, the server will return the same response as the first request. The idempotency key is valid for 24 hours.")] = None,
        create_wallet_request: Optional[CreateWalletRequest] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def create_internal_wallet_without_preload_content(
        self,
        idempotency_key: Annotated[Optional[StrictStr], Field(description="A unique identifier for the request. If the request is sent multiple times with the same idempotency key, the server will return the same response as the first request. The idempotency key is valid for 24 hours.")] = None,
        create_wallet_request: Optional[CreateWalletRequest] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def create_internal_wallet_asset_with_http_info(
        self,
        wallet_id: Annotated[StrictStr, Field(description="The ID of the wallet")],
        asset_id: Annotated[StrictStr, Field(description="The ID of the asset to add")],
        idempotency_key: Annotated[Optional[StrictStr], Field(description="A unique identifier for the request. If the request is sent multiple times with the same idempotency key, the server will return the same response as the first request. The idempotency key is valid for 24 hours.")] = None,
    ...
    @validate_call
    def create_internal_wallet_asset_without_preload_content(
        self,
        wallet_id: Annotated[StrictStr, Field(description="The ID of the wallet")],
        asset_id: Annotated[StrictStr, Field(description="The ID of the asset to add")],
        idempotency_key: Annotated[Optional[StrictStr], Field(description="A unique identifier for the request. If the request is sent multiple times with the same idempotency key, the server will return the same response as the first request. The idempotency key is valid for 24 hours.")] = None,
    ...
    @validate_call
    def delete_internal_wallet_with_http_info(
        self,
        wallet_id: Annotated[StrictStr, Field(description="The ID of the wallet to delete")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def delete_internal_wallet_without_preload_content(
        self,
        wallet_id: Annotated[StrictStr, Field(description="The ID of the wallet to delete")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def delete_internal_wallet_asset_with_http_info(
        self,
        wallet_id: Annotated[StrictStr, Field(description="The ID of the wallet")],
        asset_id: Annotated[StrictStr, Field(description="The ID of the asset to delete")],
        _request_timeout: Union[
    ...
    @validate_call
    def delete_internal_wallet_asset_without_preload_content(
        self,
        wallet_id: Annotated[StrictStr, Field(description="The ID of the wallet")],
        asset_id: Annotated[StrictStr, Field(description="The ID of the asset to delete")],
        _request_timeout: Union[
    ...
    @validate_call
    def get_internal_wallet_with_http_info(
        self,
        wallet_id: Annotated[StrictStr, Field(description="The ID of the wallet to return")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_internal_wallet_without_preload_content(
        self,
        wallet_id: Annotated[StrictStr, Field(description="The ID of the wallet to return")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_internal_wallet_asset_with_http_info(
        self,
        wallet_id: Annotated[StrictStr, Field(description="The ID of the wallet")],
        asset_id: Annotated[StrictStr, Field(description="The ID of the asset to return")],
        _request_timeout: Union[
    ...
    @validate_call
    def get_internal_wallet_asset_without_preload_content(
        self,
        wallet_id: Annotated[StrictStr, Field(description="The ID of the wallet")],
        asset_id: Annotated[StrictStr, Field(description="The ID of the asset to return")],
        _request_timeout: Union[
    ...
    @validate_call
    def get_internal_wallets_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def get_internal_wallets_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def set_customer_ref_id_for_internal_wallet_with_http_info(
        self,
        wallet_id: Annotated[StrictStr, Field(description="The wallet ID")],
        set_customer_ref_id_request: SetCustomerRefIdRequest,
        idempotency_key: Annotated[Optional[StrictStr], Field(description="A unique identifier for the request. If the request is sent multiple times with the same idempotency key, the server will return the same response as the first request. The idempotency key is valid for 24 hours.")] = None,
    ...
    @validate_call
    def set_customer_ref_id_for_internal_wallet_without_preload_content(
        self,
        wallet_id: Annotated[StrictStr, Field(description="The wallet ID")],
        set_customer_ref_id_request: SetCustomerRefIdRequest,
        idempotency_key: Annotated[Optional[StrictStr], Field(description="A unique identifier for the request. If the request is sent multiple times with the same idempotency key, the server will return the same response as the first request. The idempotency key is valid for 24 hours.")] = None,
