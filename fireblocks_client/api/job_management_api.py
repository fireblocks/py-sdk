...
class JobManagementApi:
    ...
    @validate_call
    def continue_job_with_http_info(
        self,
        job_id: Annotated[StrictStr, Field(description="The requested job id")],
        idempotency_key: Annotated[Optional[StrictStr], Field(description="A unique identifier for the request. If the request is sent multiple times with the same idempotency key, the server will return the same response as the first request. The idempotency key is valid for 24 hours.")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def continue_job_without_preload_content(
        self,
        job_id: Annotated[StrictStr, Field(description="The requested job id")],
        idempotency_key: Annotated[Optional[StrictStr], Field(description="A unique identifier for the request. If the request is sent multiple times with the same idempotency key, the server will return the same response as the first request. The idempotency key is valid for 24 hours.")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def get_job_tasks_with_http_info(
        self,
        job_id: Annotated[StrictStr, Field(description="The requested job id")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_job_tasks_without_preload_content(
        self,
        job_id: Annotated[StrictStr, Field(description="The requested job id")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def pause_job_without_preload_content(
        self,
        job_id: Annotated[StrictStr, Field(description="The requested job id")],
        idempotency_key: Annotated[Optional[StrictStr], Field(description="A unique identifier for the request. If the request is sent multiple times with the same idempotency key, the server will return the same response as the first request. The idempotency key is valid for 24 hours.")] = None,
        _request_timeout: Union[
