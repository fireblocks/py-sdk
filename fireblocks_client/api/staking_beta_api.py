...
class StakingBetaApi:
    ...
    def approve_terms_of_service_by_provider_id(
        self,
        provider_id: Annotated[StrictStr, Field(description="The unique identifier of the staking provider")],
    ...
    @validate_call
    def approve_terms_of_service_by_provider_id_with_http_info(
        self,
        provider_id: Annotated[StrictStr, Field(description="The unique identifier of the staking provider")],
        idempotency_key: Annotated[Optional[StrictStr], Field(description="A unique identifier for the request. If the request is sent multiple times with the same idempotency key, the server will return the same response as the first request. The idempotency key is valid for 24 hours.")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def approve_terms_of_service_by_provider_id_without_preload_content(
        self,
        provider_id: Annotated[StrictStr, Field(description="The unique identifier of the staking provider")],
        idempotency_key: Annotated[Optional[StrictStr], Field(description="A unique identifier for the request. If the request is sent multiple times with the same idempotency key, the server will return the same response as the first request. The idempotency key is valid for 24 hours.")] = None,
        _request_timeout: Union[
    ...
    def execute_action(
        self,
        chain_descriptor: Annotated[StrictStr, Field(description="The protocol identifier (e.g. \"ETH\"/\"SOL\") to use")],
        action_id: Annotated[StrictStr, Field(description="The operation that can be executed on a vault/position")],
        ...
        :param chain_descriptor: The protocol identifier (e.g. \"ETH\"/\"SOL\") to use (required)
        :type chain_descriptor: str
        :param action_id: The operation that can be executed on a vault/position (required)
        :type action_id: str
    ...
    def _execute_action_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/staking/chains/{chainDescriptor}/{actionId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_all_delegations(
        self,
        chain_descriptor: Annotated[Optional[StrictStr], Field(description="Use \"ETH\" / \"SOL\" in order to obtain information related to the specific blockchain network or retrieve information about all chains that have data available by providing no argument.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param chain_descriptor: Use \"ETH\" / \"SOL\" in order to obtain information related to the specific blockchain network or retrieve information about all chains that have data available by providing no argument.
        :type chain_descriptor: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
    ...
    @validate_call
    def get_all_delegations_with_http_info(
        self,
        chain_descriptor: Annotated[Optional[StrictStr], Field(description="Use \"ETH\" / \"SOL\" in order to obtain information related to the specific blockchain network or retrieve information about all chains that have data available by providing no argument.")] = None,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[DelegationDto]]:
        """
    ...
    @validate_call
    def get_all_delegations_without_preload_content(
        self,
        chain_descriptor: Annotated[Optional[StrictStr], Field(description="Use \"ETH\" / \"SOL\" in order to obtain information related to the specific blockchain network or retrieve information about all chains that have data available by providing no argument.")] = None,
        _request_timeout: Union[
            None,
    ...
    def _get_all_delegations_serialize(
        ...
        if chain_descriptor is not None:
            ...
            _query_params.append(('chainDescriptor', chain_descriptor))
    ...
    def get_chain_info_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ChainInfoResponseDto]:
        """
    ...
    @validate_call
    def get_chains_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def get_delegation_by_id_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="The unique identifier of the staking position")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_delegation_by_id_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="The unique identifier of the staking position")],
        _request_timeout: Union[
            None,
    ...
    def get_summary_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[DelegationSummaryDto]:
        """
    ...
    def get_summary_by_vault(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "Dict[str, DelegationSummaryDto]",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    @validate_call
    def get_summary_by_vault_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[Dict[str, DelegationSummaryDto]]:
        """
    ...
    @validate_call
    def get_summary_by_vault_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
