...
class TokenizationApi:
    ...
    @validate_call
    def get_linked_token_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="The token link id")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_linked_token_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="The token link id")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_linked_tokens_with_http_info(
        self,
        page_cursor: Annotated[Optional[StrictStr], Field(description="Page cursor to get the next page")] = None,
        page_size: Annotated[Optional[Union[Annotated[float, Field(le=100, strict=True, ge=1)], Annotated[int, Field(le=100, strict=True, ge=1)]]], Field(description="Number of items per page, requesting more then max will return max items")] = None,
        status: Annotated[Optional[Any], Field(description="A comma separated list of statuses to filter. Default is \"COMPLETED\"")] = None,
    ...
    @validate_call
    def get_linked_tokens_without_preload_content(
        self,
        page_cursor: Annotated[Optional[StrictStr], Field(description="Page cursor to get the next page")] = None,
        page_size: Annotated[Optional[Union[Annotated[float, Field(le=100, strict=True, ge=1)], Annotated[int, Field(le=100, strict=True, ge=1)]]], Field(description="Number of items per page, requesting more then max will return max items")] = None,
        status: Annotated[Optional[Any], Field(description="A comma separated list of statuses to filter. Default is \"COMPLETED\"")] = None,
    ...
    @validate_call
    def issue_new_token_with_http_info(
        self,
        create_token_request_dto: CreateTokenRequestDto,
        idempotency_key: Annotated[Optional[StrictStr], Field(description="A unique identifier for the request. If the request is sent multiple times with the same idempotency key, the server will return the same response as the first request. The idempotency key is valid for 24 hours.")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def issue_new_token_without_preload_content(
        self,
        create_token_request_dto: CreateTokenRequestDto,
        idempotency_key: Annotated[Optional[StrictStr], Field(description="A unique identifier for the request. If the request is sent multiple times with the same idempotency key, the server will return the same response as the first request. The idempotency key is valid for 24 hours.")] = None,
        _request_timeout: Union[
    ...
    def link(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "TokenLinkDto",
            '201': "TokenLinkDto",
            '404': "AssetDoesNotExistHttpError",
