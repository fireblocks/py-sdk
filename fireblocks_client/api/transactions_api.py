...
class TransactionsApi(object):
    ...
    def get_transactions(self, before : Annotated[Optional[StrictStr], Field(description="Unix timestamp in milliseconds. Returns only transactions created before the specified date")] = None, after : Annotated[Optional[StrictStr], Field(description="Unix timestamp in milliseconds. Returns only transactions created after the specified date")] = None, status : Annotated[Optional[StrictStr], Field(description="You can filter by one of the statuses.")] = None, order_by : Annotated[Optional[StrictStr], Field(description="The field to order the results by  **Note**: Ordering by a field that is not createdAt may result with transactions that receive updates as you request the next or previous pages of results, resulting with missing those transactions.")] = None, sort : Annotated[Optional[StrictStr], Field(description="The direction to order the results by")] = None, limit : Annotated[Optional[conint(strict=True, ge=1)], Field(description="Limits the number of results. If not provided, a limit of 200 will be used. The maximum allowed limit is 500")] = None, source_type : Annotated[Optional[StrictStr], Field(description="The source type of the transaction")] = None, source_id : Annotated[Optional[StrictStr], Field(description="The source ID of the transaction")] = None, dest_type : Annotated[Optional[StrictStr], Field(description="The destination type of the transaction")] = None, dest_id : Annotated[Optional[StrictStr], Field(description="The destination ID of the transaction")] = None, assets : Annotated[Optional[StrictStr], Field(description="A list of assets to filter by, seperated by commas")] = None, tx_hash : Annotated[Optional[StrictStr], Field(description="Returns only results with a specified txHash")] = None, source_wallet_id : Annotated[Optional[StrictStr], Field(description="Returns only results where the source is a specific end user wallet")] = None, dest_wallet_id : Annotated[Optional[StrictStr], Field(description="Returns only results where the destination is a specific end user wallet")] = None, **kwargs) -> List[TransactionResponse]:  # noqa: E501
        ...
        >>> thread = api.get_transactions(before, after, status, order_by, sort, limit, source_type, source_id, dest_type, dest_id, assets, tx_hash, source_wallet_id, dest_wallet_id, async_req = True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.get_transactions_with_http_info(before, after, status, order_by, sort, limit, source_type, source_id, dest_type, dest_id, assets, tx_hash, source_wallet_id, dest_wallet_id, **kwargs)  # noqa: E501
    ...
    def get_transactions_with_http_info(self, before : Annotated[Optional[StrictStr], Field(description="Unix timestamp in milliseconds. Returns only transactions created before the specified date")] = None, after : Annotated[Optional[StrictStr], Field(description="Unix timestamp in milliseconds. Returns only transactions created after the specified date")] = None, status : Annotated[Optional[StrictStr], Field(description="You can filter by one of the statuses.")] = None, order_by : Annotated[Optional[StrictStr], Field(description="The field to order the results by  **Note**: Ordering by a field that is not createdAt may result with transactions that receive updates as you request the next or previous pages of results, resulting with missing those transactions.")] = None, sort : Annotated[Optional[StrictStr], Field(description="The direction to order the results by")] = None, limit : Annotated[Optional[conint(strict=True, ge=1)], Field(description="Limits the number of results. If not provided, a limit of 200 will be used. The maximum allowed limit is 500")] = None, source_type : Annotated[Optional[StrictStr], Field(description="The source type of the transaction")] = None, source_id : Annotated[Optional[StrictStr], Field(description="The source ID of the transaction")] = None, dest_type : Annotated[Optional[StrictStr], Field(description="The destination type of the transaction")] = None, dest_id : Annotated[Optional[StrictStr], Field(description="The destination ID of the transaction")] = None, assets : Annotated[Optional[StrictStr], Field(description="A list of assets to filter by, seperated by commas")] = None, tx_hash : Annotated[Optional[StrictStr], Field(description="Returns only results with a specified txHash")] = None, source_wallet_id : Annotated[Optional[StrictStr], Field(description="Returns only results where the source is a specific end user wallet")] = None, dest_wallet_id : Annotated[Optional[StrictStr], Field(description="Returns only results where the destination is a specific end user wallet")] = None, **kwargs):  # noqa: E501
        ...
        >>> thread = api.get_transactions_with_http_info(before, after, status, order_by, sort, limit, source_type, source_id, dest_type, dest_id, assets, tx_hash, source_wallet_id, dest_wallet_id, async_req=True)
        >>> result = thread.get()
        ...
        if _params.get('source_wallet_id') is not None:  # noqa: E501
            _query_params.append(('sourceWalletId', _params['source_wallet_id']))

        if _params.get('dest_wallet_id') is not None:  # noqa: E501
            _query_params.append(('destWalletId', _params['dest_wallet_id']))
