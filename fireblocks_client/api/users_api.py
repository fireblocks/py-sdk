...
class UsersApi(object):
    ...
    @validate_arguments
    def get_users(self, **kwargs) -> GetUsersResponse:  # noqa: E501
        """List users  # noqa: E501

        List all users for the workspace.  Please note that this endpoint is available only for API keys with Admin permissions.   # noqa: E501
