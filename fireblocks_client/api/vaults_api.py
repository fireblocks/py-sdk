...
from pydantic import Field, StrictBool, StrictFloat, StrictStr, confloat, constr
...
class VaultsApi(object):
    ...
    @validate_arguments
    def get_paged_vault_accounts(self, name_prefix : Optional[StrictStr] = None, name_suffix : Optional[StrictStr] = None, min_amount_threshold : Optional[StrictFloat] = None, asset_id : Optional[StrictStr] = None, max_bip44_address_index_used : Optional[StrictFloat] = None, max_bip44_change_address_index_used : Optional[StrictFloat] = None, order_by : Optional[StrictStr] = None, before : Optional[StrictStr] = None, after : Optional[StrictStr] = None, limit : Optional[confloat(ge=500, le=1, strict=True)] = None, **kwargs) -> VaultAccountsPagedResponse:  # noqa: E501
        ...
        >>> thread = api.get_paged_vault_accounts(name_prefix, name_suffix, min_amount_threshold, asset_id, max_bip44_address_index_used, max_bip44_change_address_index_used, order_by, before, after, limit, async_req=True)
        >>> result = thread.get()
        ...
        :param asset_id:
        :type asset_id: str
        :param max_bip44_address_index_used:
        :type max_bip44_address_index_used: float
        :param max_bip44_change_address_index_used:
        :type max_bip44_change_address_index_used: float
        :param order_by:
        :type order_by: str
        :param before:
        :type before: str
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.get_paged_vault_accounts_with_http_info(name_prefix, name_suffix, min_amount_threshold, asset_id, max_bip44_address_index_used, max_bip44_change_address_index_used, order_by, before, after, limit, **kwargs)  # noqa: E501

    @validate_arguments
    def get_paged_vault_accounts_with_http_info(self, name_prefix : Optional[StrictStr] = None, name_suffix : Optional[StrictStr] = None, min_amount_threshold : Optional[StrictFloat] = None, asset_id : Optional[StrictStr] = None, max_bip44_address_index_used : Optional[StrictFloat] = None, max_bip44_change_address_index_used : Optional[StrictFloat] = None, order_by : Optional[StrictStr] = None, before : Optional[StrictStr] = None, after : Optional[StrictStr] = None, limit : Optional[confloat(ge=500, le=1, strict=True)] = None, **kwargs):  # noqa: E501
        """List vault acounts (Paginated)  # noqa: E501
        ...
        >>> thread = api.get_paged_vault_accounts_with_http_info(name_prefix, name_suffix, min_amount_threshold, asset_id, max_bip44_address_index_used, max_bip44_change_address_index_used, order_by, before, after, limit, async_req=True)
        >>> result = thread.get()
        ...
        _all_params = [
            ...
            'asset_id',
            'max_bip44_address_index_used',
            'max_bip44_change_address_index_used',
            'order_by',
            'before',
            'after',
            'limit'
        ...
        if _params.get('max_bip44_address_index_used') is not None:  # noqa: E501
            _query_params.append(('maxBip44AddressIndexUsed', _params['max_bip44_address_index_used']))

        if _params.get('max_bip44_change_address_index_used') is not None:  # noqa: E501
            _query_params.append(('maxBip44ChangeAddressIndexUsed', _params['max_bip44_change_address_index_used']))
    ...
    @validate_arguments
    def get_vault_accounts(self, name_prefix : Optional[StrictStr] = None, name_suffix : Optional[StrictStr] = None, min_amount_threshold : Optional[StrictFloat] = None, asset_id : Optional[StrictStr] = None, max_bip44_address_index_used : Optional[StrictFloat] = None, max_bip44_change_address_index_used : Optional[StrictFloat] = None, **kwargs) -> List[VaultAccount]:  # noqa: E501
        ...
        >>> thread = api.get_vault_accounts(name_prefix, name_suffix, min_amount_threshold, asset_id, max_bip44_address_index_used, max_bip44_change_address_index_used, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.get_vault_accounts_with_http_info(name_prefix, name_suffix, min_amount_threshold, asset_id, max_bip44_address_index_used, max_bip44_change_address_index_used, **kwargs)  # noqa: E501

    @validate_arguments
    def get_vault_accounts_with_http_info(self, name_prefix : Optional[StrictStr] = None, name_suffix : Optional[StrictStr] = None, min_amount_threshold : Optional[StrictFloat] = None, asset_id : Optional[StrictStr] = None, max_bip44_address_index_used : Optional[StrictFloat] = None, max_bip44_change_address_index_used : Optional[StrictFloat] = None, **kwargs):  # noqa: E501
        """List vault accounts  # noqa: E501
        ...
        >>> thread = api.get_vault_accounts_with_http_info(name_prefix, name_suffix, min_amount_threshold, asset_id, max_bip44_address_index_used, max_bip44_change_address_index_used, async_req=True)
        >>> result = thread.get()
