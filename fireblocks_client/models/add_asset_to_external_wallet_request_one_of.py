...
class AddAssetToExternalWalletRequestOneOf(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AddAssetToExternalWalletRequestOneOf:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AddAssetToExternalWalletRequestOneOf:
        """Create an instance of AddAssetToExternalWalletRequestOneOf from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return AddAssetToExternalWalletRequestOneOf.parse_obj(obj)

        _obj = AddAssetToExternalWalletRequestOneOf.parse_obj({
