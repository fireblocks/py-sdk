...
class AddAssetToExternalWalletRequestOneOf1AdditionalInfo(BaseModel):
    ...
    one_of_schemas: List[str] = Field(default=Literal["AddAssetToExternalWalletRequestOneOf1AdditionalInfoOneOf", "AddAssetToExternalWalletRequestOneOf1AdditionalInfoOneOf1", "AddAssetToExternalWalletRequestOneOf1AdditionalInfoOneOf2"])
