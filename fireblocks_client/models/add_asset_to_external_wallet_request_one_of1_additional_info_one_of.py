...
class AddAssetToExternalWalletRequestOneOf1AdditionalInfoOneOf(BaseModel):
    """
    ...
    iban: StrictStr = ...
    iban_city: StrictStr = Field(..., alias="ibanCity")
    iban_country: StrictStr = Field(..., alias="ibanCountry")
    __properties = ["accountHolderGivenName", "accountHolderSurname", "accountHolderCity", "accountHolderCountry", "accountHolderAddress1", "accountHolderAddress2", "accountHolderDistrict", "accountHolderPostalCode", "iban", "ibanCity", "ibanCountry"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AddAssetToExternalWalletRequestOneOf1AdditionalInfoOneOf:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AddAssetToExternalWalletRequestOneOf1AdditionalInfoOneOf:
        """Create an instance of AddAssetToExternalWalletRequestOneOf1AdditionalInfoOneOf from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return AddAssetToExternalWalletRequestOneOf1AdditionalInfoOneOf.parse_obj(obj)

        _obj = AddAssetToExternalWalletRequestOneOf1AdditionalInfoOneOf.parse_obj({
