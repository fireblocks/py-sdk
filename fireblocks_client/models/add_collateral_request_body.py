...
class AddCollateralRequestBody(BaseModel):
    ...
    is_src_collateral: Optional[StrictBool] = Field(default=None, description="optional", alias="isSrcCollateral")
    __properties: ClassVar[List[str]] = ["transactionRequest", "isSrcCollateral"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "isSrcCollateral": obj.get("isSrcCollateral")
        })
        return _obj
