...
class ContractAttributes(BaseModel):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of auditor
        if self.auditor:
            _dict['auditor'] = self.auditor.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "auditor": AuditorData.from_dict(obj["auditor"]) if obj.get("auditor") is not None else None
        })
        return _obj
