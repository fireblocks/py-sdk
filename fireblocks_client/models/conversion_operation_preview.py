...
class ConversionOperationPreview(BaseModel):
    """
    ConversionOperationPreview
    """ # noqa: E501
    input: ConversionOperationConfigParams
    output: Optional[ConversionOperationPreviewOutput] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "output": ConversionOperationPreviewOutput.from_dict(obj["output"]) if obj.get("output") is not None else None,
