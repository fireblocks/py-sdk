...
class ConvertAssetsRequest(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ConvertAssetsRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ConvertAssetsRequest:
        """Create an instance of ConvertAssetsRequest from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return ConvertAssetsRequest.parse_obj(obj)

        _obj = ConvertAssetsRequest.parse_obj({
