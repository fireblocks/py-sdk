...
class CreateAddressRequest(BaseModel):
    ...
    """ # noqa: E501
    description: Optional[StrictStr] = Field(default=None, description="(Optional) Attach a description to the new address")
    ...
    __properties: ClassVar[List[str]] = ["description", "customerRefId"]
