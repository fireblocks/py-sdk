...
class CreateAddressResponse(BaseModel):
    ...
    __properties = ["address", "legacyAddress", "enterpriseAddress", "tag", "bip44AddressIndex"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateAddressResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateAddressResponse:
        """Create an instance of CreateAddressResponse from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return CreateAddressResponse.parse_obj(obj)

        _obj = CreateAddressResponse.parse_obj({
