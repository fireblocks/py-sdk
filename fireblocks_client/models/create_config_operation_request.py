...
class CreateConfigOperationRequest(BaseModel):
    ...
    one_of_schemas: List[str] = Field(default=Literal["CreateConversionConfigOperationRequest", "CreateDisbursementConfigOperationRequest", "CreateTransferConfigOperationRequest"])
