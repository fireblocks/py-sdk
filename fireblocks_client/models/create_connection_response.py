...
class CreateConnectionResponse(BaseModel):
    ...
    session_metadata: SessionMetadata = Field(description="Metadata of the Web3 connection (provided by the DApp).", alias="sessionMetadata")
    __properties: ClassVar[List[str]] = ["id", "sessionMetadata"]
