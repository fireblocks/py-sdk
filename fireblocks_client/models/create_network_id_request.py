...
class CreateNetworkIdRequest(BaseModel):
    ...
    __properties = ["name", "routingPolicy"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateNetworkIdRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateNetworkIdRequest:
        """Create an instance of CreateNetworkIdRequest from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return CreateNetworkIdRequest.parse_obj(obj)

        _obj = CreateNetworkIdRequest.parse_obj({
            "name": obj.get("name"),
