...
class CreateVaultAccountConnectionRequest(BaseModel):
    """
    CreateVaultAccountConnectionRequest
    """ # noqa: E501
    vault_account_id: Union[StrictFloat, StrictInt] = Field(description="The ID of the vault to connect to the dApp.", alias="vaultAccountId")
    ...
    __properties: ClassVar[List[str]] = ["vaultAccountId", "feeLevel", "uri", "chainIds"]
