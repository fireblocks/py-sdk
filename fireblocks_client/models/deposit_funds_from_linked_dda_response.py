...
class DepositFundsFromLinkedDDAResponse(BaseModel):
    """
    DepositFundsFromLinkedDDAResponse
    """ # noqa: E501
    success: StrictBool = Field(description="Indicates whether the funds were successfully deposited from the linked DDA")
