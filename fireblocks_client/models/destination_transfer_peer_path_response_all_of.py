...
class DestinationTransferPeerPathResponseAllOf(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DestinationTransferPeerPathResponseAllOf:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DestinationTransferPeerPathResponseAllOf:
        """Create an instance of DestinationTransferPeerPathResponseAllOf from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return DestinationTransferPeerPathResponseAllOf.parse_obj(obj)

        _obj = DestinationTransferPeerPathResponseAllOf.parse_obj({
            "name": obj.get("name"),
