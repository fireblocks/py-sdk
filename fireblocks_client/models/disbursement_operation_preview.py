...
class DisbursementOperationPreview(BaseModel):
    """
    DisbursementOperationPreview
    """ # noqa: E501
    input: DisbursementOperationInput
    output: Optional[DisbursementOperationPreviewOutput] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "output": DisbursementOperationPreviewOutput.from_dict(obj["output"]) if obj.get("output") is not None else None,
