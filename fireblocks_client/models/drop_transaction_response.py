...
class DropTransactionResponse(BaseModel):
    ...
    """ # noqa: E501
    tx_status: Optional[StrictStr] = Field(default=None, alias="txStatus")
    tx_id: Optional[StrictStr] = Field(default=None, alias="txId")
    replaced_tx_hash: Optional[StrictStr] = Field(default=None, alias="replacedTxHash")
    __properties: ClassVar[List[str]] = ["txStatus", "txId", "replacedTxHash"]
