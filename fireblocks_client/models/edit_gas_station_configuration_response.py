...
class EditGasStationConfigurationResponse(BaseModel):
    """
    EditGasStationConfigurationResponse
    """ # noqa: E501
    success: StrictBool = Field(description="Indicates whether editing the gas station configuration was successful")
