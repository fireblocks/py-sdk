...
class EstimatedTransactionFeeResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EstimatedTransactionFeeResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EstimatedTransactionFeeResponse:
        """Create an instance of EstimatedTransactionFeeResponse from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return EstimatedTransactionFeeResponse.parse_obj(obj)

        _obj = EstimatedTransactionFeeResponse.parse_obj({
