...
class ExecutionScreeningOperation(BaseModel):
    """
    ExecutionScreeningOperation
    """ # noqa: E501
    operation_id: StrictStr = Field(alias="operationId")
    status: ExecutionOperationStatus
    operation_type: ScreeningOperationType = Field(alias="operationType")
    validation_failure: Optional[ScreeningValidationFailure] = Field(default=None, alias="validationFailure")
    execution: Optional[ScreeningOperationExecution] = None
    __properties: ClassVar[List[str]] = ["operationId", "status", "operationType", "validationFailure", "execution"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "validationFailure": ScreeningValidationFailure.from_dict(obj["validationFailure"]) if obj.get("validationFailure") is not None else None,
            "execution": ScreeningOperationExecution.from_dict(obj["execution"]) if obj.get("execution") is not None else None
        })
        return _obj
