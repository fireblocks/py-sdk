...
class ExecutionTransferOperation(BaseModel):
    """
    ExecutionTransferOperation
    """ # noqa: E501
    operation_id: StrictStr = Field(alias="operationId")
    status: ExecutionOperationStatus
    validation_failure: Optional[TransferValidationFailure] = Field(default=None, alias="validationFailure")
    operation_type: TransferOperationType = Field(alias="operationType")
    preview: Optional[TransferOperationPreview] = None
    execution: Optional[TransferOperationExecution] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "validationFailure": TransferValidationFailure.from_dict(obj["validationFailure"]) if obj.get("validationFailure") is not None else None,
            "operationType": obj.get("operationType"),
            "preview": TransferOperationPreview.from_dict(obj["preview"]) if obj.get("preview") is not None else None,
            "execution": TransferOperationExecution.from_dict(obj["execution"]) if obj.get("execution") is not None else None
        })
        return _obj
