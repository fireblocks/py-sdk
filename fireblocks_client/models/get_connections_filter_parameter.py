...
class GetConnectionsFilterParameter(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetConnectionsFilterParameter:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetConnectionsFilterParameter:
        """Create an instance of GetConnectionsFilterParameter from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return GetConnectionsFilterParameter.parse_obj(obj)

        _obj = GetConnectionsFilterParameter.parse_obj({
            "id": obj.get("id"),
