...
class GetNFTTokens200Response(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetNFTTokens200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetNFTTokens200Response:
        """Create an instance of GetNFTTokens200Response from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return GetNFTTokens200Response.parse_obj(obj)

        _obj = GetNFTTokens200Response.parse_obj({
