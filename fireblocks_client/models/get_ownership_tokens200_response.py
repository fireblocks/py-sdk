...
class GetOwnershipTokens200Response(BaseModel):
    """
    GetOwnershipTokens200Response
    """
    paging: Optional[Paging] = None
    data: Optional[conlist(TokenOwnershipResponse)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetOwnershipTokens200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetOwnershipTokens200Response:
        """Create an instance of GetOwnershipTokens200Response from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return GetOwnershipTokens200Response.parse_obj(obj)

        _obj = GetOwnershipTokens200Response.parse_obj({
            "paging": Paging.from_dict(obj.get("paging")) if obj.get("paging") is not None else None,
            "data": [TokenOwnershipResponse.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None
        })
        return _obj
