...
class ListOwnedCollections200Response(BaseModel):
    """
    ListOwnedCollections200Response
    """
    paging: Optional[Paging] = None
    data: Optional[conlist(CollectionOwnershipResponse)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListOwnedCollections200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListOwnedCollections200Response:
        """Create an instance of ListOwnedCollections200Response from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return ListOwnedCollections200Response.parse_obj(obj)

        _obj = ListOwnedCollections200Response.parse_obj({
            "paging": Paging.from_dict(obj.get("paging")) if obj.get("paging") is not None else None,
            "data": [CollectionOwnershipResponse.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None
        })
        return _obj
