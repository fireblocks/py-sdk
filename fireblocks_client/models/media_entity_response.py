...
class MediaEntityResponse(BaseModel):
    ...
    content_type: StrictStr = Field(description="Media type", alias="contentType")
    __properties: ClassVar[List[str]] = ["url", "contentType"]

    @field_validator('content_type')
    def content_type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['IMAGE', 'VIDEO', 'ANIMATION', 'THREE_D', 'TEXT', 'GIF', 'UNKNOWN_TYPE', 'SVG', 'AUDIO']):
