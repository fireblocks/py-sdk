...
class NetworkFee(BaseModel):
    ...
    base_fee: Optional[StrictStr] = Field(default=None, description="(optional) Base Fee according to EIP-1559 (ETH assets)", alias="baseFee")
    priority_fee: Optional[StrictStr] = Field(default=None, description="(optional) Priority Fee according to EIP-1559 (ETH assets)", alias="priorityFee")
    __properties: ClassVar[List[str]] = ["feePerByte", "gasPrice", "networkFee", "baseFee", "priorityFee"]
