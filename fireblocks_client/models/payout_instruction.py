...
class PayoutInstruction(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "payeeAccount", "amount"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "payeeAccount": PayeeAccount.from_dict(obj["payeeAccount"]) if obj.get("payeeAccount") is not None else None,
