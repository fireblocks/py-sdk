...
class PayoutInstructionResponse(BaseModel):
    ...
    __properties = ["id", "payeeAccount", "amount", "state", "transactions"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PayoutInstructionResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PayoutInstructionResponse:
        """Create an instance of PayoutInstructionResponse from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return PayoutInstructionResponse.parse_obj(obj)

        _obj = PayoutInstructionResponse.parse_obj({
            "id": obj.get("id"),
            "payee_account": PayeeAccountResponse.from_dict(obj.get("payeeAccount")) if obj.get("payeeAccount") is not None else None,
