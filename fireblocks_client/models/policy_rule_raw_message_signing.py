...
class PolicyRuleRawMessageSigning(BaseModel):
    ...
    derivation_path: Optional[PolicyRuleRawMessageSigningDerivationPath] = Field(default=None, alias="derivationPath")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "derivationPath": PolicyRuleRawMessageSigningDerivationPath.from_dict(obj["derivationPath"]) if obj.get("derivationPath") is not None else None
        })
        return _obj
