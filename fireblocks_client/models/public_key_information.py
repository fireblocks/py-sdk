...
class PublicKeyInformation(BaseModel):
    """
    ...
    __properties = ["algorithm", "derivationPath", "publicKey"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PublicKeyInformation:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PublicKeyInformation:
        """Create an instance of PublicKeyInformation from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return PublicKeyInformation.parse_obj(obj)

        _obj = PublicKeyInformation.parse_obj({
