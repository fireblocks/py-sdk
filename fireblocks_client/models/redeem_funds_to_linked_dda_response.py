...
class RedeemFundsToLinkedDDAResponse(BaseModel):
    """
    RedeemFundsToLinkedDDAResponse
    """ # noqa: E501
    success: StrictBool = Field(description="Indicates whether the funds were successfully redeemed to the linked DDA")
