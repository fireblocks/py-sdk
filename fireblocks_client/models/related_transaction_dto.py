...
class RelatedTransactionDto(BaseModel):
    """
    RelatedTransactionDto
    """ # noqa: E501
    tx_id: StrictStr = Field(description="The transaction ID", alias="txId")
    completed: StrictBool = Field(description="Is the transaction completed or not")
    __properties: ClassVar[List[str]] = ["txId", "completed"]
