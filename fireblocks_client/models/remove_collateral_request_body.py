...
class RemoveCollateralRequestBody(BaseModel):
    ...
    is_dst_collateral: Optional[StrictBool] = Field(None, alias="isDstCollateral", description="optional")
    __properties = ["transactionRequest", "isDstCollateral"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RemoveCollateralRequestBody:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RemoveCollateralRequestBody:
        """Create an instance of RemoveCollateralRequestBody from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return RemoveCollateralRequestBody.parse_obj(obj)

        _obj = RemoveCollateralRequestBody.parse_obj({
            ...
            "is_dst_collateral": obj.get("isDstCollateral")
        })
        return _obj
