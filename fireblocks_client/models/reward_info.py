...
class RewardInfo(BaseModel):
    ...
    """ # noqa: E501
    src_rewards: Optional[StrictStr] = Field(default=None, alias="srcRewards")
    dest_rewards: Optional[StrictStr] = Field(default=None, alias="destRewards")
    __properties: ClassVar[List[str]] = ["srcRewards", "destRewards"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "srcRewards": obj.get("srcRewards"),
            "destRewards": obj.get("destRewards")
        })
        return _obj
