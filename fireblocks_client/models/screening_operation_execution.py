...
class ScreeningOperationExecution(BaseModel):
    """
    ScreeningOperationExecution
    """ # noqa: E501
    output: Optional[ScreeningOperationExecutionOutput] = None
    ...
    failure: Optional[ScreeningOperationFailure] = None
    __properties: ClassVar[List[str]] = ["output", "startedAt", "finishedAt", "failure"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "output": ScreeningOperationExecutionOutput.from_dict(obj["output"]) if obj.get("output") is not None else None,
            "startedAt": obj.get("startedAt"),
            "finishedAt": obj.get("finishedAt"),
            "failure": ScreeningOperationFailure.from_dict(obj["failure"]) if obj.get("failure") is not None else None
        })
        return _obj
