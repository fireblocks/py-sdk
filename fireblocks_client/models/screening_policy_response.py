...
class ScreeningPolicyResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["policy", "policyStatus", "isDefault", "createDate", "lastUpdate"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "policy": TravelRulePolicyRuleResponse.from_dict(obj["policy"]) if obj.get("policy") is not None else None,
