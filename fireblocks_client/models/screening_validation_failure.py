...
class ScreeningValidationFailure(BaseModel):
    """
    ...
    def reason_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['SCREENING_DISABLED_IN_TENANT']):
            raise ValueError("must be one of enum values ('SCREENING_DISABLED_IN_TENANT')")
        return value
