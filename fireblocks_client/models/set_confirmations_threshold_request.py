...
class SetConfirmationsThresholdRequest(BaseModel):
    ...
    """ # noqa: E501
    num_of_confirmations: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="numOfConfirmations")
    __properties: ClassVar[List[str]] = ["numOfConfirmations"]
