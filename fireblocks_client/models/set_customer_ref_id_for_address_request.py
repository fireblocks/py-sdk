...
class SetCustomerRefIdForAddressRequest(BaseModel):
    """
    SetCustomerRefIdForAddressRequest
    """ # noqa: E501
    customer_ref_id: Optional[StrictStr] = Field(default=None, description="Customer reference ID", alias="customerRefId")
    __properties: ClassVar[List[str]] = ["customerRefId"]
