...
class SetRoutingPolicyForNetworkConnectionRequest(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SetRoutingPolicyForNetworkConnectionRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SetRoutingPolicyForNetworkConnectionRequest:
        """Create an instance of SetRoutingPolicyForNetworkConnectionRequest from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return SetRoutingPolicyForNetworkConnectionRequest.parse_obj(obj)

        _obj = SetRoutingPolicyForNetworkConnectionRequest.parse_obj({
