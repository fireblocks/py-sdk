...
class SmartTransferBadRequestResponse(BaseModel):
    """
    SmartTransferBadRequestResponse
    """ # noqa: E501
    message: StrictStr = Field(description="Bad request error message")
    code: StrictStr = Field(description="Bad request error code")
