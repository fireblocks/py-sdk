...
class SmartTransferManuallyFundTerm(BaseModel):
    """
    SmartTransferManuallyFundTerm
    """ # noqa: E501
    tx_hash: Annotated[str, Field(strict=True, max_length=64)] = Field(alias="txHash")
    __properties: ClassVar[List[str]] = ["txHash"]
