...
class SourceTransferPeerPathResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SourceTransferPeerPathResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SourceTransferPeerPathResponse:
        """Create an instance of SourceTransferPeerPathResponse from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return SourceTransferPeerPathResponse.parse_obj(obj)

        _obj = SourceTransferPeerPathResponse.parse_obj({
            "type": obj.get("type"),
