...
class StellarRippleCreateParamsDto(BaseModel):
    """
    ...
    issuer_address: StrictStr = Field(description="The address of the issuer of this token. Will be part of the identifier of this token on chain.", alias="issuerAddress")
    __properties: ClassVar[List[str]] = ["symbol", "name", "issuerAddress"]
