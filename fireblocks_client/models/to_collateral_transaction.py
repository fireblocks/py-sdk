...
class ToCollateralTransaction(BaseModel):
    ...
    src_tag: Optional[StrictStr] = Field(default=None, description="optional", alias="srcTag")
    fee: Optional[StrictStr] = Field(default=None, description="optional")
    __properties: ClassVar[List[str]] = ["asset", "amount", "srcAddress", "srcTag", "fee"]
