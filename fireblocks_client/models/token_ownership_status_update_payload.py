...
class TokenOwnershipStatusUpdatePayload(BaseModel):
    """
    TokenOwnershipStatusUpdatePayload
    """ # noqa: E501
    asset_id: StrictStr = Field(description="Token's asset id", alias="assetId")
    status: StrictStr = Field(description="Token's ownership new status")
    __properties: ClassVar[List[str]] = ["assetId", "status"]
