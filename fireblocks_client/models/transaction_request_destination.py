...
class TransactionRequestDestination(BaseModel):
    ...
    __properties = ["amount", "destination"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TransactionRequestDestination:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TransactionRequestDestination:
        """Create an instance of TransactionRequestDestination from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return TransactionRequestDestination.parse_obj(obj)

        _obj = TransactionRequestDestination.parse_obj({
