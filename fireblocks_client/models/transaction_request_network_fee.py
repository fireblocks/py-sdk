...
class TransactionRequestNetworkFee(BaseModel):
    ...
    actual_instance: Any
    one_of_schemas: List[str] = Literal[TRANSACTIONREQUESTNETWORKFEE_ONE_OF_SCHEMAS]
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TransactionRequestNetworkFee:
        return cls.from_json(json.dumps(obj))

    @classmethod
    def from_json(cls, json_str: str) -> TransactionRequestNetworkFee:
