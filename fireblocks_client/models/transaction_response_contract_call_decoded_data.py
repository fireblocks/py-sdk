...
class TransactionResponseContractCallDecodedData(BaseModel):
    ...
    function_calls: Optional[List[Dict[str, Any]]] = Field(default=None, alias="functionCalls")
    __properties: ClassVar[List[str]] = ["contractName", "functionCalls"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "functionCalls": obj.get("functionCalls")
        })
        return _obj
