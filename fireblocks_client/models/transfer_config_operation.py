...
class TransferConfigOperation(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["operationId", "type", "params", "status", "validationFailure"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "type": obj.get("type"),
            "params": TransferOperationConfigParams.from_dict(obj["params"]) if obj.get("params") is not None else None,
