...
class TransferOperationPreviewOutput(BaseModel):
    """
    TransferOperationPreviewOutput
    """ # noqa: E501
    amount: AssetAmount
    fee: AssetAmount
    is_sign_required: StrictBool = Field(alias="isSignRequired")
    time_seconds: Union[StrictFloat, StrictInt] = Field(alias="timeSeconds")
    __properties: ClassVar[List[str]] = ["amount", "fee", "isSignRequired", "timeSeconds"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "isSignRequired": obj.get("isSignRequired"),
