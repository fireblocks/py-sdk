...
class TravelRuleIssuer(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TravelRuleIssuer:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TravelRuleIssuer:
        """Create an instance of TravelRuleIssuer from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return TravelRuleIssuer.parse_obj(obj)

        _obj = TravelRuleIssuer.parse_obj({
