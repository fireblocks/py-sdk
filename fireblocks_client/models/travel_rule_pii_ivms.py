...
class TravelRulePiiIVMS(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TravelRulePiiIVMS:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TravelRulePiiIVMS:
        """Create an instance of TravelRulePiiIVMS from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return TravelRulePiiIVMS.parse_obj(obj)

        _obj = TravelRulePiiIVMS.parse_obj({
