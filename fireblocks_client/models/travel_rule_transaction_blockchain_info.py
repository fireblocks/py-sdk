...
class TravelRuleTransactionBlockchainInfo(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TravelRuleTransactionBlockchainInfo:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TravelRuleTransactionBlockchainInfo:
        """Create an instance of TravelRuleTransactionBlockchainInfo from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return TravelRuleTransactionBlockchainInfo.parse_obj(obj)

        _obj = TravelRuleTransactionBlockchainInfo.parse_obj({
