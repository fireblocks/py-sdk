...
class TravelRuleValidateFullTransactionRequestBeneficiary(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TravelRuleValidateFullTransactionRequestBeneficiary:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TravelRuleValidateFullTransactionRequestBeneficiary:
        """Create an instance of TravelRuleValidateFullTransactionRequestBeneficiary from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return TravelRuleValidateFullTransactionRequestBeneficiary.parse_obj(obj)

        _obj = TravelRuleValidateFullTransactionRequestBeneficiary.parse_obj({
