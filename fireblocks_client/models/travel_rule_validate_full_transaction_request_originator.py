...
class TravelRuleValidateFullTransactionRequestOriginator(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TravelRuleValidateFullTransactionRequestOriginator:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TravelRuleValidateFullTransactionRequestOriginator:
        """Create an instance of TravelRuleValidateFullTransactionRequestOriginator from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return TravelRuleValidateFullTransactionRequestOriginator.parse_obj(obj)

        _obj = TravelRuleValidateFullTransactionRequestOriginator.parse_obj({
