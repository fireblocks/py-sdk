...
class UnspentInput(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UnspentInput:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UnspentInput:
        """Create an instance of UnspentInput from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return UnspentInput.parse_obj(obj)

        _obj = UnspentInput.parse_obj({
