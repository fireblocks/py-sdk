...
class UpdateDraftRequest(BaseModel):
    ...
    UpdateDraftRequest
    """
    rules: Optional[conlist(PolicyRule)] = Field(None, description="rules to update the draft with")
    __properties = ["rules"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UpdateDraftRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UpdateDraftRequest:
        """Create an instance of UpdateDraftRequest from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return UpdateDraftRequest.parse_obj(obj)

        _obj = UpdateDraftRequest.parse_obj({
