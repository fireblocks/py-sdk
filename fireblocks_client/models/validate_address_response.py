...
class ValidateAddressResponse(BaseModel):
    ...
    requires_tag: Optional[StrictBool] = Field(default=None, alias="requiresTag")
    __properties: ClassVar[List[str]] = ["isValid", "isActive", "requiresTag"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "requiresTag": obj.get("requiresTag")
        })
        return _obj
