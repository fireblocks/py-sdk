...
class WorkflowExecutionOperation(BaseModel):
    ...
    one_of_schemas: List[str] = Field(default=Literal["ExecutionConversionOperation", "ExecutionDisbursementOperation", "ExecutionScreeningOperation", "ExecutionTransferOperation"])
