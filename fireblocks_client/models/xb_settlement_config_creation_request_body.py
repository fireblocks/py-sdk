...
class XBSettlementConfigCreationRequestBody(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> XBSettlementConfigCreationRequestBody:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> XBSettlementConfigCreationRequestBody:
        """Create an instance of XBSettlementConfigCreationRequestBody from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return XBSettlementConfigCreationRequestBody.parse_obj(obj)

        _obj = XBSettlementConfigCreationRequestBody.parse_obj({
            "name": obj.get("name"),
