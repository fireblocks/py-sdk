...
class BaseApi(api_client.Api):
    ...
    def _redeem_funds_to_linked_dda_oapg(self, params: typing.Union[SchemaForRequestBodyApplicationJson,dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader, RequestPathParams] = None, request_options: RequestOptions = None):
        """
        Redeem funds to DDA
        """
        path_params = {}
...
class RedeemFundsToLinkedDda(BaseApi):
    ...
    def redeem_funds_to_linked_dda(self ,params: typing.Union[SchemaForRequestBodyApplicationJson,dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader, RequestPathParams] = None, request_options: RequestOptions = None):
...
class ApiForpost(BaseApi):
    ...
    def post(
        ...
        return self._redeem_funds_to_linked_dda_oapg(
            body=body,
