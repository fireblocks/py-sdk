...
class BaseApi(api_client.Api):
    ...
    def _create_internal_wallet_asset_oapg(self, params: typing.Union[SchemaForRequestBodyApplicationJson,dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader, RequestPathParams] = None, request_options: RequestOptions = None):
        """
...
class CreateInternalWalletAsset(BaseApi):
    ...
    def create_internal_wallet_asset(self ,params: typing.Union[SchemaForRequestBodyApplicationJson,dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader, RequestPathParams] = None, request_options: RequestOptions = None):
...
class ApiForpost(BaseApi):
    ...
    def post(
        ...
        return self._create_internal_wallet_asset_oapg(
            body=body,
