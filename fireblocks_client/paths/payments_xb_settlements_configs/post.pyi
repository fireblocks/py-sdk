...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_xb_settlement_config_oapg(
        self,
    ...
    def _create_xb_settlement_config_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_xb_settlement_config_creation_request_body.serialize(body, content_type)
...
class CreateXbSettlementConfig(BaseApi):
    ...
    @typing.overload
    def create_xb_settlement_config(
        self,
        content_type: typing_extensions.Literal["application/json"] = ...,
        body: typing.Union[SchemaForRequestBodyApplicationJson, schemas.Unset] = schemas.unset,
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
