...
class BaseApi(api_client.Api):
    @typing.overload
    def _update_xb_settlement_config_oapg(
        self,
    ...
    def _update_xb_settlement_config_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_xb_settlement_config_edit_request_body.serialize(body, content_type)
...
class UpdateXbSettlementConfig(BaseApi):
    ...
    @typing.overload
    def update_xb_settlement_config(
        self,
        content_type: typing_extensions.Literal["application/json"] = ...,
        body: typing.Union[SchemaForRequestBodyApplicationJson, schemas.Unset] = schemas.unset,
        path_params: RequestPathParams = frozendict.frozendict(),
