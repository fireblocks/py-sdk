...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_xb_settlement_flow_oapg(
        self,
    ...
    def _create_xb_settlement_flow_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_xb_settlement_create_flow_request_body.serialize(body, content_type)
