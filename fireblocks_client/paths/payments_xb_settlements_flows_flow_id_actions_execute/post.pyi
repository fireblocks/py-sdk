...
class BaseApi(api_client.Api):
    @typing.overload
    def _execute_xb_settlement_flow_action_oapg(
        self,
    ...
    def _execute_xb_settlement_flow_action_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_xb_settlement_flow_execution_request_body.serialize(body, content_type)
...
class ExecuteXbSettlementFlowAction(BaseApi):
    ...
    @typing.overload
    def execute_xb_settlement_flow_action(
        self,
        content_type: typing_extensions.Literal["application/json"] = ...,
        body: typing.Union[SchemaForRequestBodyApplicationJson, schemas.Unset] = schemas.unset,
        path_params: RequestPathParams = frozendict.frozendict(),
