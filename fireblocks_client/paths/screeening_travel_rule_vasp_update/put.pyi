...
class BaseApi(api_client.Api):
    @typing.overload
    def _travel_rule_api_controller_update_vasp_oapg(
        self,
    ...
    def _travel_rule_api_controller_update_vasp_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_travel_rule_update_vasp_details.serialize(body, content_type)
...
class TravelRuleApiControllerUpdateVasp(BaseApi):
    ...
    @typing.overload
    def travel_rule_api_controller_update_vasp(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationJson,],
        content_type: typing_extensions.Literal["application/json"] = ...,
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
