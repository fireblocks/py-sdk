...
class BaseApi(api_client.Api):
    ...
    def _create_vault_account_asset_oapg(self, params: typing.Union[SchemaForRequestBodyApplicationJson,dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader, RequestPathParams] = None, request_options: RequestOptions = None):
        """
        Create a new wallet
        """
        path_params = {}
...
class CreateVaultAccountAsset(BaseApi):
    ...
    def create_vault_account_asset(self ,params: typing.Union[SchemaForRequestBodyApplicationJson,dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader, RequestPathParams] = None, request_options: RequestOptions = None):
...
class ApiForpost(BaseApi):
    ...
    def post(
        ...
        return self._create_vault_account_asset_oapg(
            body=body,
