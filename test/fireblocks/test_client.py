...
def test_get_compliance_orchestrator_beta(fireblocks_instance):
    assert isinstance(fireblocks_instance.compliance_orchestrator_beta, ComplianceOrchestratorBetaApi)
...
def test_get_contacts(fireblocks_instance):
    assert isinstance(fireblocks_instance.contacts, ContactsApi)
...
def test_get_onchain_data(fireblocks_instance):
    assert isinstance(fireblocks_instance.onchain_data, OnchainDataApi)
...
def test_get_tr_link(fireblocks_instance):
    assert isinstance(fireblocks_instance.tr_link, TRLinkApi)
...
def test_get_utxo_management_beta(fireblocks_instance):
    assert isinstance(fireblocks_instance.utxo_management_beta, UTXOManagementBetaApi)
