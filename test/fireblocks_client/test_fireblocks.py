...
def fireblocks_instance(mocker):
    try:
        mocker.patch('fireblocks_client.fireblocks.ThreadedApiClient', return_value=MagicMock(spec=ThreadedApiClient))
...
def test_get_staking_beta(fireblocks_instance):
    assert isinstance(fireblocks_instance.staking_beta, StakingBetaApi)
