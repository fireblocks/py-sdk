...
from fireblocks_client.threaded_api_client import ThreadedApiClient
from fireblocks_client.client_configuration import ClientConfiguration
from fireblocks_client.bearer_token_provider import BearerTokenProvider
from fireblocks_client.rest import RESTClientObject, RESTResponse
from fireblocks_client.api_client import ApiResponse
from fireblocks_client.exceptions import ApiException
from fireblocks_client.models.error_schema import ErrorSchema
from fireblocks_client.unknown_model import UnknownBaseModel
...
def setup_mocks(request, mock_bearer_token_provider, mock_rest_client, mocker):
    mocker.patch('fireblocks_client.api_client.rest.RESTClientObject', return_value=mock_rest_client)
    mocker.patch('fireblocks_client.threaded_api_client.BearerTokenProvider', return_value=mock_bearer_token_provider)
