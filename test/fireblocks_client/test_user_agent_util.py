...
import pytest
from fireblocks_client.user_agent_util import UserAgentUtil
...
@pytest.mark.parametrize("is_anonymous_platform, user_agent, expected", [
    (False, "customUserAgent", "customUserAgent fireblocks/sdk/python/0.0.2-beta (Linux 5.4.0-42-generic; x86_64)"),
    (True, "customUserAgent", "customUserAgent fireblocks/sdk/python/0.0.2-beta"),
    (False, None, "fireblocks/sdk/python/0.0.2-beta (Linux 5.4.0-42-generic; x86_64)"),
    (True, None, "fireblocks/sdk/python/0.0.2-beta")])
