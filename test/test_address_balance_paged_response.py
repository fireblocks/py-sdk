...
class TestAddressBalancePagedResponse(unittest.TestCase):
    """AddressBalancePagedResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AddressBalancePagedResponse:
        """Test AddressBalancePagedResponse
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `AddressBalancePagedResponse`
        """
    ...
    def testAddressBalancePagedResponse(self):
        """Test AddressBalancePagedResponse"""
