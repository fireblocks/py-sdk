...
class TestBlockchainAddress(unittest.TestCase):
    """BlockchainAddress unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BlockchainAddress:
        """Test BlockchainAddress
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `BlockchainAddress`
        """
    ...
    def testBlockchainAddress(self):
        """Test BlockchainAddress"""
