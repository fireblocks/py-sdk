...
class TestCipsAddress(unittest.TestCase):
    """CipsAddress unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CipsAddress:
        """Test CipsAddress
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `CipsAddress`
        """
        model = CipsAddress()
        if include_optional:
            return CipsAddress(
