...
class TestConnectedAccountsResponse(unittest.TestCase):
    """ConnectedAccountsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ConnectedAccountsResponse:
        """Test ConnectedAccountsResponse
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `ConnectedAccountsResponse`
        """
    ...
    def testConnectedAccountsResponse(self):
        """Test ConnectedAccountsResponse"""
