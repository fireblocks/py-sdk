...
',
                ...
                attributes = fireblocks_client.models.contract_attributes.ContractAttributes(
                    use_cases = [
                        ''
                        ], 
                    standards = [
                    ...
                    auditor = fireblocks_client.models.auditor_data.AuditorData(
                        name = '', 
                        image_url = '', 
                        link = '', ), ),
                docs = fireblocks_client.models.contract_doc.ContractDoc(
                ...
                vendor = fireblocks_client.models.vendor_dto.VendorDto(
