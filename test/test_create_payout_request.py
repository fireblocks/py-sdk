...
from fireblocks_client.models.create_payout_request import CreatePayoutRequest  # noqa: E501
...
class TestCreatePayoutRequest(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        """
        model = fireblocks_client.models.create_payout_request.CreatePayoutRequest()  # noqa: E501
        if include_optional :
        return CreatePayoutRequest(
            payment_account = fireblocks_client.models.payment_account.PaymentAccount(
                    id = '', 
                    type = 'VAULT_ACCOUNT', ), 
            instruction_set = [
                    fireblocks_client.models.payout_instruction.PayoutInstruction(
                        id = '', 
