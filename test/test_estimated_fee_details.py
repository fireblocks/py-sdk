...
class TestEstimatedFeeDetails(unittest.TestCase):
    """EstimatedFeeDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EstimatedFeeDetails:
        """Test EstimatedFeeDetails
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `EstimatedFeeDetails`
        """
    ...
    def testEstimatedFeeDetails(self):
        """Test EstimatedFeeDetails"""
