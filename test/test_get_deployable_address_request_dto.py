...
class TestGetDeployableAddressRequestDto(unittest.TestCase):
    """GetDeployableAddressRequestDto unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetDeployableAddressRequestDto:
        """Test GetDeployableAddressRequestDto
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `GetDeployableAddressRequestDto`
        """
        model = GetDeployableAddressRequestDto()
        if include_optional:
            return GetDeployableAddressRequestDto(
    ...
    def testGetDeployableAddressRequestDto(self):
        """Test GetDeployableAddressRequestDto"""
