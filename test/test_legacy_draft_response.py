...
class TestLegacyDraftResponse(unittest.TestCase):
    """LegacyDraftResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LegacyDraftResponse:
        """Test LegacyDraftResponse
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `LegacyDraftResponse`
        """
        model = LegacyDraftResponse()
        if include_optional:
    ...
    def testLegacyDraftResponse(self):
        """Test LegacyDraftResponse"""
