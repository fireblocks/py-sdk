...
class TestLegacyPolicyAndValidationResponse(unittest.TestCase):
    """LegacyPolicyAndValidationResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LegacyPolicyAndValidationResponse:
        """Test LegacyPolicyAndValidationResponse
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `LegacyPolicyAndValidationResponse`
        """
        model = LegacyPolicyAndValidationResponse()
        if include_optional:
            return LegacyPolicyAndValidationResponse(
                policy = fireblocks.models.legacy_policy_response.LegacyPolicyResponse(
                    rules = [
    ...
    def testLegacyPolicyAndValidationResponse(self):
        """Test LegacyPolicyAndValidationResponse"""
