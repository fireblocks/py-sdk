...
class TestLegacyPolicyRules(unittest.TestCase):
    """LegacyPolicyRules unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LegacyPolicyRules:
        """Test LegacyPolicyRules
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `LegacyPolicyRules`
        """
        model = LegacyPolicyRules()
        if include_optional:
            return LegacyPolicyRules(
                rules = [
    ...
    def testLegacyPolicyRules(self):
        """Test LegacyPolicyRules"""
