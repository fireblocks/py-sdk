...
class TestLegacyPublishResult(unittest.TestCase):
    """LegacyPublishResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LegacyPublishResult:
        """Test LegacyPublishResult
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `LegacyPublishResult`
        """
        model = LegacyPublishResult()
        if include_optional:
    ...
    def testLegacyPublishResult(self):
        """Test LegacyPublishResult"""
