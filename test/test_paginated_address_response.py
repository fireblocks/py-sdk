    ...
    def make_instance(self, include_optional) -> PaginatedAddressResponse:
        ...
        if include_optional:
            return PaginatedAddressResponse(
                addresses = [
                    fireblocks_client.models.vault_wallet_address.VaultWalletAddress(
                        asset_id = '', 
                        address = '', 
                        description = '', 
                        tag = '', 
                ...
                paging = fireblocks_client.models.paginated_address_response_paging.PaginatedAddressResponse_paging(
                    before = '', 
                    after = '', )
            )
        else:
