        ...
        if include_optional:
            return RemoveCollateralRequestBody(
                transaction_request = fireblocks_client.models.transaction_request.TransactionRequest(
                    ...
                    asset_id = 'ETH', 
                    source = fireblocks_client.models.source_transfer_peer_path.SourceTransferPeerPath(
                        type = 'VAULT_ACCOUNT', 
                        sub_type = 'BINANCE', 
                        id = '', 
                        name = '', 
                        wallet_id = '', ), 
                    destination = fireblocks_client.models.destination_transfer_peer_path.DestinationTransferPeerPath(
                        type = 'VAULT_ACCOUNT', 
                        id = '', 
                        name = '', 
                        wallet_id = '', 
                    ...
                    travel_rule_message = fireblocks_client.models.travel_rule_create_transaction_request.TravelRuleCreateTransactionRequest(
                        originator_vas_pdid = '', 
