    ...
    def make_instance(self, include_optional) -> TokenOwnershipResponse:
        ...
        if include_optional:
            return TokenOwnershipResponse(
                ...
                spam = fireblocks_client.models.spam_ownership_response.SpamOwnershipResponse(
                    result = True, 
                    source = 'OWNER', ),
                collection = fireblocks_client.models.token_collection_response.TokenCollectionResponse(
                    id = '', 
                    name = '', 
                    symbol = '', ),
                balance = '',
