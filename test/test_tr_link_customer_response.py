...
class TestTRLinkCustomerResponse(unittest.TestCase):
    """TRLinkCustomerResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TRLinkCustomerResponse:
        """Test TRLinkCustomerResponse
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `TRLinkCustomerResponse`
        """
        model = TRLinkCustomerResponse()
        if include_optional:
    ...
    def testTRLinkCustomerResponse(self):
        """Test TRLinkCustomerResponse"""
